...
class PermisosPerfilVocacionalSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permisox = 'apvfmodu';
        $compleme = 'Módulo administraccion perfil vocacional';
        Permission::create([
        ...
        //permisos administraccion areas perfil vocacional
        $permisox = 'apvfarea';
        $compleme = 'perfil vacacional areas';
        Permission::create([
            'name' => $permisox . '-leerxxxx',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
        ...
        $permisox = 'apvfacti';
        $compleme = 'Perfil vocacional actividades';
        Permission::create([
            'name' => $permisox . '-leerxxxx',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
