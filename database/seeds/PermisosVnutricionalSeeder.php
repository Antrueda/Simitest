...
class PermisosVnutricionalSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //formulario VALORACIÓN Y SEGUIMIENTO NUTRICIONAL COMPLETA  
        $permisox = 'vnutrici';
        $compleme = 'VALORACIÓN Y SEGUIMIENTO NUTRICIONAL COMPLETA';
        Permission::create([
        ...
        //formulario SEGUIMIENTO NUTRICIONAL COMPLETA  
        $permisox = 'vnutsegu';
        $compleme = 'SEGUIMIENTO NUTRICIONAL COMPLETA';
        Permission::create([
            'name' => $permisox . '-leerxxxx',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
