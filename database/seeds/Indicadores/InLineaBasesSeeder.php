...
class InLineaBasesSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    $dataxxxx['s_linea_base'] = 'Identificación de evento estresante o traumático ante presunto abuso sexual #######1.';
    InLineaBase::create($dataxxxx); // 14
    $dataxxxx['s_linea_base'] = 'Identificación de #######1 basada en xxxxxxx2, ante el evento el NNAJ ha emitido #######3 #######4 de quitarse la vida. 
    El NNAJ ha emitido xxxxxxx1 de quitarse la vida o xxxxxxx2.';
    InLineaBase::create($dataxxxx); // 15
    $dataxxxx['s_linea_base'] = 'El AJ ha presentado #######1 debido #######2.';
    InLineaBase::create($dataxxxx); // 16
    $dataxxxx['s_linea_base'] = 'El AJ ha presentado xxxxxxx1 debido a su xxxxxxx2';
    InLineaBase::create($dataxxxx); // 17
    $dataxxxx['s_linea_base'] = 'Identificación de abandono del(os) cuidadores y/o representantes legales y/o cuidadores.';
    ...
    $dataxxxx['s_linea_base'] = 'Identificación de relaciones familiares conflictivas y/o  distantes xxxxxxx1 ';
    InLineaBase::create($dataxxxx); // 21
    $dataxxxx['s_linea_base'] = 'Identificación de #######1 xxxxxxx2 con escasa xxxxxxx3.';
    ...
    $dataxxxx['s_linea_base'] = 'Identificación de #######1 xxxxxxx2 xxxxxxx3.';
    ...
    $dataxxxx['s_linea_base'] = 'Identificación de violencia intrafamiliar ejercido por #######1 xxxxxxx2 xxxxxxx3.';
    InLineaBase::create($dataxxxx); // 26
    $dataxxxx['s_linea_base'] = 'Identificación de violencia intrafamiliar #######1 xxxxxxx2.';
