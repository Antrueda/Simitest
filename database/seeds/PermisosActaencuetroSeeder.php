...
class PermisosActaencuetroSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /** Módulo acta de encuentro */
        $permisox = 'actamodu';
        $compleme = 'Módulo acta de encuentro';
        Permission::create([
        ...
        $permisox = 'aecontac';
        $compleme = 'Contactos del acta de encuentro';
        Permission::create([
            'name' => $permisox . '-leerxxxx',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
        ...
        $permisox = 'asistenc';
        $compleme = 'Asistencia del acta de encuentro';
        Permission::create([
            'name' => $permisox . '-leerxxxx',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
        ...
        $permisox = 'asisnnaj';
        $compleme = 'NNAJs Asistentes del acta de encuentro';
        Permission::create([
            'name' => $permisox . '-leerxxxx',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
        ...
        $permisox = 'aerecurs';
        $compleme = 'Asignación de los recursos para el acta de encuentro';
        Permission::create([
            'name' => $permisox . '-leerxxxx',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
        ...
        /** Módulo administracion asistencias */
        $permisox = 'actenadm';
        $compleme = 'Módulo administración acta de encuentro';
        Permission::create([
            'name' => $permisox . '-moduloxx',
            'sis_pestania_id' => 1,
            'descripcion' => $moduloxx . $compleme,
        ...
        $permisox = 'aerecadm';
        $compleme = 'Administracion de los recursos del acta de encuentro';
        Permission::create([
            'name' => $permisox . '-leerxxxx',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
