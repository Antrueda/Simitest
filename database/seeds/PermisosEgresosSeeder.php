...
class PermisosEgresosSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permisox = 'egresosder';
        $compleme = 'Egreso Verificacion de derechos';
        Permission::create([
            'name' => $permisox . '-leer',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
        ...
        $permisox = 'egresoredes';
        $compleme = 'egreso redes de apoyo';
        Permission::create([
            'name' => $permisox . '-leer',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
        ...
        //permisos para seguimiento post egreso
        $permisox = 'egresopost';
        $compleme = 'Seguimiento Post Egreso';
        Permission::create([
            'name' => $permisox . '-leer',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
        ...
        $permisox = 'egresocomite';
        $compleme = 'Comite de egreso';
        Permission::create([
            'name' => $permisox . '-leer',
            'sis_pestania_id' => 1,
            'descripcion' => $leerxxxx . $compleme,
