...
class CreateCsdComFamiliarsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tablaxxx, function (Blueprint $table) {
            ...
            $table->integer('prm_ocupacion_id')->unsigned();
            $table->integer('prm_parentezco_id')->unsigned();
            $table->integer('prm_convive_id')->unsigned();
            $table->integer('prm_visitado_id')->unsigned();
            $table->integer('prm_vin_actual_id')->unsigned();
            $table->integer('prm_vin_pasado_id')->unsigned();
            $table->integer('prm_regimen_id')->unsigned();
            $table->integer('prm_cualeps_id')->unsigned()->nullable();
            $table->decimal('sisben', 19, 2)->nullable();
            $table->integer('prm_sisben_id')->unsigned();
            $table->integer('prm_discapacidad_id')->unsigned();
            $table->integer('prm_cual_id')->unsigned()->nullable();
            $table->integer('prm_peso_id')->unsigned();
            $table->integer('prm_peso_dos_id')->unsigned()->nullable();
            $table->integer('prm_leer_id')->unsigned();
            $table->integer('prm_escribir_id')->unsigned();
            $table->integer('prm_operaciones_id')->unsigned();
            $table->integer('prm_aprobado_id')->unsigned()->nullable();
            $table->integer('prm_educacion_id')->unsigned();
