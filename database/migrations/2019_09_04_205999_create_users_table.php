...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tablaxxx, function (Blueprint $table) {
            $table->increments('id')->start(2240)->nocache()->comment('CAMPO DE LLAVE PRIMARIA DE LA TABLA');
            ...
            $table->integer('user_edita_id')->nullable()->unsigned();
            ...
            $table->integer('sis_esta_id')->unsigned()->comment('CAMPO DE ESTADO');
