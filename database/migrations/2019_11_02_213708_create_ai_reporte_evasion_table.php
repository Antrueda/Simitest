...
class CreateAiReporteEvasionTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement("ALTER TABLE `{$this->tablaxxx}` comment 'TABLA QUE ALMACENA LOS DETALLES DEL ESCAPE DE UN BENEFICIARIO DEL IDIPRIN DE UNA UPI DENTRO DE LAS ACCIONES GRUPALES'");
    }
