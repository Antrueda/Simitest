...
{
    private $tablaxxx = 'ag_asistentes';
    /**
     * Run the migrations.
     *
     * @return void
    ...
    public function up()
    {
        ...
        // DB::statement("ALTER TABLE `{$this->tablaxxx}` comment 'TABLA QUE ALMACENA QUIENES ASISTEN A LAS ACTIVIDADES DENTRO DEL CONTEXTO DE LOS TALLERES BRINDADO EN LAS ACCIONES GRUPALES.'");
