...
class CreateCsdDinFamiliarsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tablaxxx, function (Blueprint $table) {
            ...
            $table->string('relevantes')->comment('CAMPO DE TEXTO RELEVANTES');
            ...
            $table->string('descripciona')->comment('CAMPO DESCRIPCION(Interpretación de la composición familiar)');
            ...
            $table->string('descripcionb')->comment('CAMPO DESCRIPCION(de hechos relevantes en las etapas de desarrollo)');
            $table->integer('prm_cuidador_id')->unsigned()->nullable()->comment('CAMPO PARAMETRO ASUME EL CUIDADO O CRIANZA');
            $table->string('descripcionc')->comment('CAMPO DESCRIPCION(CUIDADO O CRIANZA)');
            $table->string('afronta')->comment('CAMPO AFRONTA LAS DIFICULTADES');
            ...
            $table->string('observacion')->nullable()->comment('CAMPO DE TEXTO OBSERVACIONES');
