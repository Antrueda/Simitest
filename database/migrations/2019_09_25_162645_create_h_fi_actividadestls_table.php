...
class CreateHFiActividadestlsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tablaxxx, function (Blueprint $table) {
            ...
            $table->integer('i_horas_permanencia_calle')->unsigned()->nullable();
            $table->integer('i_dias_permanencia_calle')->unsigned()->nullable();
            $table->integer('i_prm_pertenece_parche_id')->unsigned()->nullable();
            $table->string('s_nombre_parche')->nullable();
            $table->integer('i_prm_acceso_recreacion_id')->unsigned()->nullable();
            $table->integer('i_prm_practica_religiosa_id')->unsigned()->nullable();
            $table->integer('i_prm_religion_practica_id')->unsigned()->nullable();
