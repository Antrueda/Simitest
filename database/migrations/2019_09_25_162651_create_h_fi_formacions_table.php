...
class CreateHFiFormacionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tablaxxx, function (Blueprint $table) {
            ...
            $table->integer('i_prm_lee_id')->unsigned();
            $table->integer('i_prm_escribe_id')->unsigned();
            $table->integer('prm_operacio_id')->unsigned();
            $table->integer('i_prm_estudia_id')->unsigned();
