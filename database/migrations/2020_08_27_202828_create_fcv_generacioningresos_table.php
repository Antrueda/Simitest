...
class CreateFcvGeneracioningresosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tablaxxx, function (Blueprint $table) {
            ...
            $table->integer('user_crea_id')->unsigned()->comment('ID DE USUARIO QUE CREA')->comment('USUARIO QUE CREA EL REGISTRO');
            $table->integer('user_edita_id')->unsigned()->comment('ID DE USUARIO QUE EDITA')->comment('USUARIO QUE EDITA EL REGISTRO');
