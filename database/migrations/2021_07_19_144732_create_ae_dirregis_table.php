...
class CreateAeDirregisTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ae_dirregis', function (Blueprint $table) {
            ...
            $table->string('s_complemento');
            $table->integer('s_nombre_via');
            $table->integer('i_prm_alfabeto_via_id')->unsigned();
            $table->integer('i_prm_tiene_bis_id')->unsigned();
            $table->integer('i_prm_bis_alfabeto_id')->unsigned();
            $table->integer('i_prm_cuadrante_vp_id')->unsigned();
            $table->integer('i_via_generadora');
            $table->integer('i_prm_alfabetico_vg_id')->unsigned();
            $table->integer('i_placa_vg');
            $table->integer('i_prm_cuadrante_vg_id')->unsigned();
