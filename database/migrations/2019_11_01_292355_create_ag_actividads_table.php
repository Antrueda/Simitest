...
class CreateAgActividadsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tablaxxx, function (Blueprint $table) {
            ...
            $table->string('s_prm_espac', 120)->nullable()->comment('CAMPO DE TEXTO PARA EL ESPACIO O LUGAR');
            $table->boolean('incompleto')->default(1);
            $table->string('s_introduc')->comment('CAMPO DE TEXTO PARA LA INTRODUCCION');
            $table->string('s_justific')->comment('CAMPO DE TEXTO PARA LA JUSTIFICACION');
            $table->string('s_objetivo')->comment('CAMPO DE TEXTO PARA EL OBJETUVO');
            $table->string('s_metodolo')->comment('CAMPO DE TEXTO PARA LA METODOLOGIA');
            $table->string('s_categori')->nullable()->comment('CAMPO DE TEXTO PARA LA CATEGORIA');
            $table->string('s_contenid')->comment('CAMPO DE TEXTO PARA EL CONTENIDO');
            $table->string('s_estrateg')->nullable()->comment('CAMPO DE TEXTO PARA LA ESTRATEGIA');
            $table->string('s_resultad')->comment('CAMPO DE TEXTO PARA EL RESULTADO');
            $table->string('s_evaluaci')->comment('CAMPO DE TEXTO PARA LA EVALUACION');
            $table->string('s_observac')->comment('CAMPO DE TEXTO PARA LA OBSERVACION');
