<?php
$controll = 'DireccionamientoAdmin\Programa';
$routxxxx = 'direcprogrma';
Route::group(['prefix' => 'ProgramaServicio'], function () use ($controll, $routxxxx) {
    Route::get('', [
        'uses' => $controll . 'Controller@index',
        'middleware' => ['permission:' . $routxxxx . '-leer|' . $routxxxx . '-crear|' . $routxxxx . '-editar|' . $routxxxx . '-borrar']
    ])->name($routxxxx);
    Route::get('listaxxx', [
        'uses' => $controll . 'Controller@listaServicio',
