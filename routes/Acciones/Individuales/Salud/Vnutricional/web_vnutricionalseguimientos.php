<?php
$routxxxx = 'vnutsegu';
$controll = 'Acciones\Individuales\Salud\Vnutricional\VnutricionalSeguimiento';

Route::group(['prefix' => 'ai/salud/v-nutricional/{padrexxx}/seguimiento'], function () use ($controll, $routxxxx) {
	Route::get('', [
...
Route::group(['prefix' => 'ai/salud/v-nutricional/seguimiento'], function () use ($controll, $routxxxx) {
