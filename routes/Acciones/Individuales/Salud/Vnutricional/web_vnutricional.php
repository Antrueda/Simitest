<?php
$routxxxx = 'vnutrici';
$controll = 'Acciones\Individuales\Salud\Vnutricional\Vnutricional';
Route::group(['prefix' => 'ai/salud/{padrexxx}/v-nutricional'], function () use ($controll, $routxxxx) {
	Route::get('', [
...
Route::group(['prefix' => 'ai/salud/v-nutricional'], function () use ($controll, $routxxxx) {
...
require_once('web_vnutricionalseguimientos.php');
