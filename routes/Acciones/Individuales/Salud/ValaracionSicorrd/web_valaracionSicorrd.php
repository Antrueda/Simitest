<?php
$routxxxx = 'vapsirrd';
$controll = 'Acciones\Individuales\Salud\ValoracionSicorrd\ValoracionSicorrd';
Route::group(['prefix' => 'ai/salud/{padrexxx}/valoracionpsrrd'], function () use ($controll, $routxxxx) {
	Route::get('', [
...
Route::group(['prefix' => 'ai/salud/valoracionpsrrd'], function () use ($controll, $routxxxx) {
...
require_once('AdmiValoracionSicorrd/web_admisicorrdmodu.php');
