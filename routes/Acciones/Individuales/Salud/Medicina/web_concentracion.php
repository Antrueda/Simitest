<?php
$routexxx = 'concentracion';
$controll = 'Acciones\Individuales\Salud\Medicina\ConcentracionController@';
Route::group(['prefix' => 'concentracion'], function () use ($routexxx, $controll) {
    Route::get('', [
        'uses' => $controll . 'index',
         'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
    ])->name($routexxx);
    Route::get('listaxxx', [
        'uses' => $controll . 'getListaConcentracion',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
