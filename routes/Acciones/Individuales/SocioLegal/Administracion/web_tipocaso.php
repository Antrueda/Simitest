<?php
$controll='Acciones\Individuales\Juridica\CasoJuridico\Administracion\TipoCaso';
$routxxxx='tipocaso';
Route::group(['prefix' => 'TipoCaso'], function () use($controll,$routxxxx){
	Route::get('', [
