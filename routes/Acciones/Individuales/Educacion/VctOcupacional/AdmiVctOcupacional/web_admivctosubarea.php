...
$controll = 'Acciones\Individuales\Educacion\VctOcupacional\AdmiVctOcupacional\VctSubareaController@';
Route::group(['prefix' => 'subarea'], function () use ($routexxx, $controll) {
    Route::get('', [
        'uses' => $controll . 'index',
