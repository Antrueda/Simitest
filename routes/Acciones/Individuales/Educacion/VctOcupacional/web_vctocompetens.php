<?php
$routexxx='vctocomp';
$controll = 'Acciones\Individuales\Educacion\VctOcupacional\FormuVtcOcupacional\VctoCompetencias';
Route::group(['prefix' => 'competencias'], function () use($routexxx,$controll) {
