<?php
$routexxx = 'avihsuba';
$controll = 'Acciones\Individuales\Educacion\ValoIdentHabOcupacional\AdmiValoIdentHab\VihoSubareaController@';

Route::group(['prefix' => '{padrexxx}/subarea'], function () use ($routexxx, $controll) {
    Route::get('', [
        'uses' => $controll . 'index',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
    ])->name($routexxx);
    Route::get('listaxxx', [
        'uses' => $controll . 'getListaSubareas',
        'middleware' => ['permission:' . $routexxx . '-leerxxxx|' . $routexxx . '-crearxxx|' . $routexxx . '-editarxx|' . $routexxx . '-borrarxx']
