<?php
$controll='Acciones\Grupales\InscripcionSena\Administracion\TipoPrograma';

$routxxxx='tipoprograma';
Route::group(['prefix' => 'TipoPrograma'], function () use($controll,$routxxxx){
	Route::get('', [
		'uses' => $controll.'Controller@index',
		'middleware' => ['permission:'.$routxxxx.'-leer|'.$routxxxx.'-crear|'.$routxxxx.'-editar|'.$routxxxx.'-borrar']
	])->name($routxxxx);
    Route::get('listaxxx', [
		'uses' => $controll.'Controller@ListaTipoPrograma',
