<?php
$controll='Acciones\Grupales\InscripcionSena\Administracion\Modalidad';
$routxxxx='modalidad';
Route::group(['prefix' => 'Modalidades'], function () use($controll,$routxxxx){
	Route::get('', [
		'uses' => $controll.'Controller@index',
		'middleware' => ['permission:'.$routxxxx.'-leer|'.$routxxxx.'-crear|'.$routxxxx.'-editar|'.$routxxxx.'-borrar']
	])->name($routxxxx);
    Route::get('listaxxx', [
		'uses' => $controll.'Controller@ListaModalidad',
