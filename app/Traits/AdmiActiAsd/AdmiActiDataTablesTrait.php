...
trait AdmiActiDataTablesTrait
{
        ...
        $this->opciones['tablasxx'] = [
            [
                ...
                'columnsx' => [
                    ...
                    ['data' => 'itemtipo', 'name' => 'itemtipo.nombre as itemtipo'],
    ...
    public function getTablasDependencias()
    {  
        $this->opciones['tablasxx'] = [
            [
                'titunuev' => 'NUEVAS DEPENDENCIAS',
