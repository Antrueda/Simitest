...
trait ParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = "PA{$this->opciones['vocalesx'][2]}S";
        ...
        $this->opciones['tituloxx'] = "PA{$this->opciones['vocalesx'][2]}S";
        $this->opciones['titucont'] = "PA{$this->opciones['vocalesx'][2]}S";
        $this->opciones['infocont'] = "País";
