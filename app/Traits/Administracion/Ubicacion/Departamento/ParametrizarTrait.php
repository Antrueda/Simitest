...
trait ParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = "DEPARTAMENTOS";
        ...
        $this->opciones['carpetax'] = 'Departamento';
        ...
        $this->opciones['tituloxx'] = "DEPARTAMENTO";
        $this->opciones['titucont'] = "DEPARTAMENTO";
        $this->opciones['infocont'] = "Departamento";
