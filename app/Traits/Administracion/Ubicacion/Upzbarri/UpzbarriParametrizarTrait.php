 ...
 */
trait UpzbarriParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = "LOCALIDAD";
        ...
        $this->opciones['carpetax'] = 'Upzbarri';
        ...
        $this->opciones['tituloxx'] = "UPZ-BARRIO";
        $this->opciones['titucont'] = "BARRIO";
        $this->opciones['infocont'] = "BARRIO";
