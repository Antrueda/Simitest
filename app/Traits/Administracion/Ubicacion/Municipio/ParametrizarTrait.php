...
trait ParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = "MUNICIPIOS";
        ...
        $this->opciones['carpetax'] = 'Municipio';
        ...
        $this->opciones['tituloxx'] = "MUNICIPIO";
        $this->opciones['titucont'] = "MUNICIPIO";
        $this->opciones['infocont'] = "Municipio";
    }
