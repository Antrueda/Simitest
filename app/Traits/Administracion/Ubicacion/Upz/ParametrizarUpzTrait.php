...
namespace App\Traits\Administracion\Ubicacion\Upz;
...
trait ParametrizarUpzTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = "ADMINISTRACIÓN PARA UPZ'S";
