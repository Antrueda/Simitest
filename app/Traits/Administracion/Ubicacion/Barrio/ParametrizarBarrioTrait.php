...
namespace App\Traits\Administracion\Ubicacion\Barrio;
...
trait ParametrizarBarrioTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = "ADMINISTRACIÓN PARA BARRIOS";
