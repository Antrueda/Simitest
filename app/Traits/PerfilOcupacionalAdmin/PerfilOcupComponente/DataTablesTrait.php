...
trait DataTablesTrait
{
    ...
    public function getTablas($dataxxxx)
    {
        ...
        $dataxxxx['tablasxx'] = [
            [
                'titunuev' => 'NUEVO COMPONENTE DE DESEMPEÑO',
                'titulist' => 'LISTA COMPONENTES DEL DESEMPEÑO',
                ...
                'columnsx' => [
                    ...
                    ['data' => 'id', 'name' => 'desempenio_componentes.id'],
                    ['data' => 'nombre', 'name' => 'desempenio_componentes.nombre'],
