...
trait DataTablesTrait
{
    ...
    public function getTablas($dataxxxx)
    {
        ...
        $dataxxxx['tablasxx'] = [
            [
                'titunuev' => 'NUEVA CATEGORÍA DE DESEMPEÑO',
                'titulist' => 'LISTA CATEGORÍAS DEL DESEMPEÑO',
                ...
                'columnsx' => [
                    ...
                    ['data' => 'id', 'name' => 'desempenio_categorias.id'],
                    ['data' => 'nombre', 'name' => 'desempenio_categorias.nombre'],
