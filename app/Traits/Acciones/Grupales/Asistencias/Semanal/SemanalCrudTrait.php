        ...
        $respuest = DB::transaction(function () use ($dataxxxx) {
            ...
            if (isset($dataxxxx['modeloxx']->id)) {
                if ($dataxxxx['requestx']->puedeeditar == "1") {
                    ...
                    $diasGrupo = Parametro::select(['parametros.id as prm_dia_id'])->join('grupo_dias', 'parametros.id', '=', 'grupo_dias.prm_dia_id')->where('grupo_dias.grupo_id', $dataxxxx['requestx']->prm_grupo_id)->get()->toArray();
                ...
                $planilla = function ($id) {
                    if ($id == 2721) {
                        return "asistencia-academica";
                    }
                    if ($id == 2724) {
                        return "asistencia-convenio";
                    }
                    if ($id == 2723) {
                        return "asistencia-tecnicaconvenio";
                    }
                    if ($id == 2722) {
                        return "asistencia-tecnicatalleres";
                    }
                };
