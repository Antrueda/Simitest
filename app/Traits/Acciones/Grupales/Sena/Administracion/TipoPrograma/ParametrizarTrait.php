...
namespace App\Traits\Acciones\Grupales\Sena\Administracion\TipoPrograma;
...
trait ParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = 'ADMINISTRACIÓN TIPO PROGRAMA';
        $this->opciones['routxxxx'] = $this->opciones['routxxxx'];
        $this->opciones['slotxxxx'] = $this->opciones['permisox'];
        $this->opciones['perfilxx'] = 'sinperfi';
        $this->opciones['rutacarp'] = 'ProgramasAdmin.';
        $this->opciones['parametr'] = [];
        $this->opciones['routingx'] = [];
        $this->opciones['carpetax'] = 'Tipoprograma';
        ...
        $this->opciones['tituloxx'] = "TIPO PROGRAMA";
    }
