    ...
    public function getTablas($dataxxxx)
    {
        ...
        $this->opciones['tablasxx'][] =
            ...
            [
                ...
                'titulist' => 'LISTA DE JOVENES CON PERMISO',
                'archdttb' => $this->opciones['rutacarp'] . 'Acomponentes.Adatatable.index',
                'titupreg' => '',
                'vercrear' => false,
                'urlxxxxx' => route('aisalidamayores.salidajovenes', $this->opciones['padrexxx']->id), // $this->opciones["urlxxxas"] = 'api/ag/asistentes';
                'permtabl' => [
                    'salidajovenes-leer',
                ],
                'cabecera' => [
                ...
                'tablaxxx' => 'datatablejovenespermiso',
                'permisox' => $this->opciones['permisox'],
                'routxxxx' => 'salidajovenes',
                'parametr' => [$this->opciones['padrexxx']->id],
            ];
