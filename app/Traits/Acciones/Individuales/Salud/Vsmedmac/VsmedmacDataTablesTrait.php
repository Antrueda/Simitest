    ...
    public function getTablas()
    {
        ...
        $this->opciones['tablasxx'] = [
            [
                ...
                'titulist' => 'LISTA VALORACiÓN Y SEGUIMIENTO MAC - RRD',
                'archdttb' => $this->opciones['rutacarp'] . 'Acomponentes.Adatatable.index',
                'vercrear' => true,
                'urlxxxxx' => route($this->opciones['permisox'] . '.listaxxx', [$this->sinnajid->id]),
                'permtabl' => [
                ...
                'cabecera' => [
                    [
                        ...
                        ['td' => 'TIPO DE VALORACIÓN', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                        ['td' => '# DE SESIÓN', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                        ['td' => 'PLAN DE MANEJO', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                        ['td' => 'CONDUCTA', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                        ['td' => 'FUNCIONARIO Y/O CONTRATISTA', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
