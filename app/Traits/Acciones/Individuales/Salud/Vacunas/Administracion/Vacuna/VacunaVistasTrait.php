...
namespace App\Traits\Acciones\Individuales\Salud\Vacunas\Administracion\Vacuna;
...
trait CgihHabilidadVistasTrait
{
    ...
    {
        $this->getBotones(['leerxxxx', [$this->opciones['routxxxx'], [$dataxxxx['padrexxx']]], 2, 'VOLVER A VACUNAS', 'btn btn-sm btn-primary']);
        ...
        if ($dataxxxx['modeloxx'] != '') {
            ...
            $this->getBotones(['crearxxx', [$this->opciones['routxxxx'].'.nuevoxxx', [$dataxxxx['padrexxx']]], 2, 'NUEVA VACUNA', 'btn btn-sm btn-primary']);
        }
