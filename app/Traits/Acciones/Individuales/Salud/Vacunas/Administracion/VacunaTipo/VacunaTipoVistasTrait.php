...
trait VacunaTipoVistasTrait
{
    ...
    {
        $this->getBotones(['leerxxxx', [$this->opciones['routxxxx'], []], 2, 'VOLVER A TIPO DE VACUNA', 'btn btn-sm btn-primary']);
        ...
        if ($dataxxxx['modeloxx'] != '') {
            ...
            $this->getBotones(['crearxxx', [$this->opciones['routxxxx'].'.nuevoxxx', []], 2, 'NUEVO TIPO DE VACUNA', 'btn btn-sm btn-primary']);
        }
