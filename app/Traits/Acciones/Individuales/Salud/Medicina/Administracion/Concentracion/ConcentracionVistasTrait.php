...
trait ConcentracionVistasTrait
{
    ...
    {
        $this->getBotones(['leerxxxx', [$this->opciones['routxxxx'], []], 2, 'VOLVER  A CONCENTRACIÓN', 'btn btn-sm btn-primary']);
        ...
        if ($dataxxxx['modeloxx'] != '') {
            ...
            $this->getBotones(['crearxxx', [$this->opciones['routxxxx'].'.nuevoxxx', []], 2, 'CREAR CONCENTRACIÓN', 'btn btn-sm btn-primary']);
        }
