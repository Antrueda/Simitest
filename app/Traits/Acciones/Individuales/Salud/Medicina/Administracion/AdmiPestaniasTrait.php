...
trait AdmiPestaniasTrait
{
     ...
     */
    public $pestania = [
        ['compuesto', '', [], 'ADMINISTRACIÓN COMPUESTO', true, '', 'Compuesto'], // por mínimo debe tener un controllador
        ['presentacion', '', [], 'ADMINISTRACIÓN PRESENTACIÓN', true, '', 'presentación'], // por mínimo debe tener un controllador
        ['concentracion', '', [], 'ADMINISTRACIÓN CONCENTRACIÓN  ', true, '', 'Concentración '], // por mínimo debe tener un controllador
        ['asociarmedicamento', '', [], 'ADMINISTRACIÓN ASOCIAR MEDICAMENTOS  ', true, '', 'Asociar Medicamentos'], // por mínimo debe tener un controllador
