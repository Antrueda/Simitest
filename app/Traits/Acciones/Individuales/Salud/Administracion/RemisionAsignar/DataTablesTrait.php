...
trait DataTablesTrait
{
    ...
    public function getTablas($dataxxxx)
    {
        ...
        $dataxxxx['tablasxx'] = [
            [
                'titunuev' => 'ASIGNAR ESPECIALIDAD',
                'titulist' => 'LISTA DE ASIGNACIONES DE ESPECIALIDAD',
                ...
                'cabecera' => [
                    [
                        ...
                        ['td' => 'REMISION', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                        ['td' => 'ESPECIALIDAD', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                ...
                'columnsx' => [
                    ...
                    ['data' => 'remisions', 'name' => 'remisions.nombre as remisions'],
                    ['data' => 'especial', 'name' => 'remiespecials.nombre as especial'],
