...
trait VnutricionalPestaniasTrait
{
    ...
    public $pestania2 = [
        ['vnutrici', '', [], 'VALORACIÓN NUTRICIONAL COMPLETA', true, '', 'Lista de valoración nutricional completa'], // por mínimo debe tener un controllador
        ['vnutsegu', '', [], 'SEGUIMIENTOS', false, '', 'Seguimientos valoración nutricional completa'], // por mínimo debe tener un controllador
    ];
    /**
