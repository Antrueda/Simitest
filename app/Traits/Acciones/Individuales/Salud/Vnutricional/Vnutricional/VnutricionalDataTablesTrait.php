 ...
 */
trait VnutricionalDataTablesTrait
{
    /**
    ...
    public function getTablas($padrexxx)
    {
        ...
        $this->opciones['tablasxx'] = [
            [
                'titunuev' => 'CREAR NUEVA VALORACIÓN NUTRICIONAL',
                'titulist' => 'LISTA DE VALORACIÓN NUTRICIONAL COMPLETA',
                ...
                'cabecera' => [
                    [
                        ...
                        ['td' => 'DIAGNÓSTICO NUTRICIONAL', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                ...
                'columnsx' => [
                    ...
                    ['data' => 'id', 'name' => 'vnutricions.id'],
                    ['data' => 'fechdili', 'name' => 'vnutricions.fechdili'],
                    ['data' => 'nombre', 'name' => 'sis_depens.nombre'],
                    ['data' => 'diagnostico', 'name' => 'diagnostico.nombre as diagnostico'],
    ...
    public function getTablasSeguimientos($padrexxx)
    {
        ...
        $this->opciones['tablasxx'] = [
            [
                'titunuev' => 'CREAR SEGUIMIENTO VALORACIÓN NUTRICIONAL',
                'titulist' => 'LISTA DE SEGUIMIENTOS VALORACIÓN NUTRICIONAL',
                'archdttb' => $this->opciones['rutacarp'] . 'Acomponentes.Adatatable.index',
                'vercrear' => true,
                'urlxxxxx' => route($this->opciones['routxxxx'] . '.listaxxx', [$padrexxx]),
                'permtabl' => [
