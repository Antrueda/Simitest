...
trait AdmiVsrrdPestaniasTrait
{

    public $pestania = [
        ['vsrrdent', '', [], 'ENTORNOS ', true, '', 'entornos'], // por mínimo debe tener un controllador
        ['vsrrdfac', '', [], 'FACTORES', true, '', 'factores'], // por mínimo debe tener un controllador
        ['vsrrdeyf', '', [], 'ASOCIAR ENTORNO Y FACTOR', true, '', 'asociar entorno factor'], // por mínimo debe tener un controllador
    ];
    /**
