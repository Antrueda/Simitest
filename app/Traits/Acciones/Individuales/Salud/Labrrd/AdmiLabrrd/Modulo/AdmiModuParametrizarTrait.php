...
namespace  App\Traits\Acciones\Individuales\Salud\Labrrd\AdmiLabrrd\Modulo;
...
trait AdmiModuParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = 'MÓDULO ADMINISTRACIÓN  VALORACIÓN (LAB- RRD)';
        ...
        $this->opciones['carpetax'] = 'AdmiLabrrd.';
