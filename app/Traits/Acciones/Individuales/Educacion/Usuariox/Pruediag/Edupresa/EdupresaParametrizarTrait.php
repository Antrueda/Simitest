 ...
 */
trait EdupresaParametrizarTrait
{
    ...
    {
        $this->opciones['rutacarp'] = 'Acciones.Individuales.Educacion.Usuariox.Pruediag.';
        $this->opciones['rutacomp'] = 'Acciones.Individuales.Educacion.Usuariox.Pruediag';
        $this->opciones['compesta'] = $this->opciones['rutacomp'] . '.Acomponentes.Acrud.pestanias';
        $this->opciones['vocalesx'] = ['Á', 'É', 'Í', 'Ó', 'Ú'];
        $this->opciones['tituhead'] = 'PRESABER-PRUEBA DIAGNÓSTICA';
        $this->opciones['tituloxx'] = $this->opciones['tituhead'];
        $this->opciones['perfilxx'] = 'conperfi';
        /** botones que se presentan en los formularios */
        $this->opciones['botonesx'] = $this->opciones['rutacomp'] . '.Acomponentes.Botones.botonesx';
        /** informacion que se va a mostrar en la vista */
        $this->opciones['formular'] = $this->opciones['rutacarp'] . ucfirst($this->opciones['permisox']) . '.formulario.formulario';
