...
trait AdmiPvfPestaniasTrait
{
    
    public $pestania = [
        ['apvfarea', '', [], 'ÁREAS DE INTERÉS ', true, '', 'áreas de interés'], // por mínimo debe tener un controllador
        ['apvfacti', '', [], 'ACTIVIDADES', false, '', 'Actividades'], // por mínimo debe tener un controllador
    ];
    /**
