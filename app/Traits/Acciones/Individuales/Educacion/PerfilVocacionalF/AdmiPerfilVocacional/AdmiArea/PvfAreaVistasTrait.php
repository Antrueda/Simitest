...
trait PvfAreaVistasTrait
{
    ...
    {
        $this->getBotones(['leerxxxx', [$this->opciones['routxxxx'], []], 2, 'VOLVER A ÁREAS DE INTERÉS', 'btn btn-sm btn-primary']);
        ...
        if ($dataxxxx['modeloxx'] != '') {
            ...
            $this->getBotones(['crearxxx', [$this->opciones['routxxxx'].'.nuevoxxx', []], 2, 'NUEVA ÁREA DE INTERÉS', 'btn btn-sm btn-primary']);
        }
