...
trait CgihLimiteVistasTrait
{
    ...
    public function view( $dataxxxx)
    {
        ...
        if ($dataxxxx['modeloxx'] != '') {
            ...
            $this->getBotones(['crearxxx', [$this->opciones['routxxxx'].'.nuevoxxx', []], 2, 'CREAR', 'btn btn-sm btn-primary']);
        }
        $this->opciones['motivoxx'] = $this->getEstusuariosAECT([
            'cabecera' => true,
            'ajaxxxxx' => false,
            'estadoid' => $estadoid,
            'formular' => 2826 //2718 de tipo de actividad 
        ])['comboxxx'];
