...
trait VihVistasTrait
{
    ...
    public function view($dataxxxx)
    {
        ...
        $this->opciones['valoracion_componente'] = Tema::combo(447, true, false);
        $this->opciones['areas_for'] = Tema::combo(448, false, false);
        ...
        if ($dataxxxx['modeloxx'] != '') {
            ...
            $this->getBotones(['crearxxx', [$this->opciones['routxxxx'] . '.nuevoxxx', [$dataxxxx['padrexxx']->id]], 2, 'NUEVO VALORACIÓN', 'btn btn-sm btn-primary']);
