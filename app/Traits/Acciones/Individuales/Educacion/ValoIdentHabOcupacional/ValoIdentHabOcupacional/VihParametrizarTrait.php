...
trait VihParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = 'VALORACIÓN E IDENTIFICACIÓN DE HABILIDADES';
        // $this->opciones['routxxxx'] = $this->opciones['permisox'];
        $this->opciones['slotxxxx'] = $this->opciones['permisox'];
        $this->opciones['perfilxx'] = 'conperfi';
        $this->opciones['rutacarp'] = 'Acciones.Individuales.Educacion.ValoIdentHabOcupacional.';
        $this->opciones['parametr'] = [];
        $this->opciones['routingx'] = [];
        $this->opciones['carpetax'] = 'ValoIdentHabOcupacional';
        ...
        $this->opciones['tituloxx'] = "VALORACIÓN E IDENTIFICACIÓN DE HABILIDADES";
    }
