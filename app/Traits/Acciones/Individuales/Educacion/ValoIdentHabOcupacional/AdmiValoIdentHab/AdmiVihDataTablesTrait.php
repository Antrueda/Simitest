        ...
        $this->opciones['tablasxx'] = [
            [
                ...
                'columnsx' => [
                    ...
                    ['data' => 'id', 'name' => 'vih_areas.id'],
                    ['data' => 'nombre', 'name' => 'vih_areas.nombre'],
                    ['data' => 'descripcion', 'name' => 'vih_areas.descripcion'],
    ...
    public function getTablasSubareas($padrexxx)
    {
        $this->opciones['tablasxx'] = [
            [
                ...
                'columnsx' => [
                    ['data' => 'botonexx', 'name' => 'botonexx'],
                    ['data' => 'id', 'name' => 'vih_subareas.id'],
                    ['data' => 'nombre', 'name' => 'vih_subareas.nombre'],
                    ['data' => 'descripcion', 'name' => 'vih_subareas.descripcion'],
                    ['data' => 'area', 'name' => 'vih_areas.nombre AS area'],
                    ['data' => 's_estado', 'name' => 'sis_estas.s_estado'],
                ],
                'tablaxxx' => 'datatable',
                'permisox' => $this->opciones['permisox'],
