...
trait AdmiVihPestaniasTrait
{
    
    public $pestania = [
        ['aviharea', '', [], 'ÁREAS ', true, '', 'áreas'], // por mínimo debe tener un controllador
        ['avihsuba', '', [], 'SUBÁREA', false, '', 'subáreas'], // por mínimo debe tener un controllador
    ];
    /**
