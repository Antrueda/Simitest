    ...
    public function getTablasSubareas()
    {
        $this->opciones['tablasxx'] = [
            [
                ...
                'columnsx' => [
                    ['data' => 'botonexx', 'name' => 'botonexx'],
                    ['data' => 'id', 'name' => 'vcto_actividades.id'],
                    ['data' => 'nombre', 'name' => 'vcto_actividades.nombre'],
                    ['data' => 'descripcion', 'name' => 'vcto_actividades.descripcion'],
        ...
        $this->opciones['tablasxx'] = [
            [
                ...
                'columnsx' => [
                    ...
                    ['data' => 'id', 'name' => 'vcto_actividades.id'],
                    ['data' => 'nombre', 'name' => 'vcto_actividades.nombre'],
                    ['data' => 'subarea', 'name' => 'vcto_areas.nombre AS subarea'],
                    ['data' => 's_estado', 'name' => 'sis_estas.s_estado'],
                ],
                'tablaxxx' => 'datatable',
                'permisox' => $this->opciones['permisox'],
