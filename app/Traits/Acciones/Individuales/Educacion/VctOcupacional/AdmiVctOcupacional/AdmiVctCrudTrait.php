...
trait AdmiVctCrudTrait
{
    ...
    public function setArea($dataxxxx)
    {
        $respuest = DB::transaction(function () use ($dataxxxx) {
            ...
            if (isset($dataxxxx['modeloxx']->id)) {
                ...
                $dataxxxx['modeloxx'] = VctoArea::create($dataxxxx['requestx']->all());
            }
    ...
    public function setSubarea($dataxxxx)
    {
        $respuest = DB::transaction(function () use ($dataxxxx) {
            ...
            if (isset($dataxxxx['modeloxx']->id)) {
                ...
                $dataxxxx['requestx']->request->add(['user_crea_id' => Auth::user()->id]);
                $dataxxxx['modeloxx'] = VctoSubarea::create($dataxxxx['requestx']->all());
            }
            return $dataxxxx['modeloxx'];
        }, 5);
        return redirect()
    ...
    public function setItem($dataxxxx)
    {
        $respuest = DB::transaction(function () use ($dataxxxx) {
            $dataxxxx['requestx']->request->add(['user_edita_id' => Auth::user()->id]);
            if (isset($dataxxxx['modeloxx']->id)) {
                ...
                $dataxxxx['requestx']->request->add(['user_crea_id' => Auth::user()->id]);
                $dataxxxx['modeloxx'] = VctoItem::create($dataxxxx['requestx']->all());
            }
            return $dataxxxx['modeloxx'];
        }, 5);
        return redirect()
