...
trait ParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = 'ADMINISTRACIÓN CATEGORÍAS COMPONENTES DEL DESEMPEÑO ';
        $this->opciones['routxxxx'] = $this->opciones['routxxxx'];
        $this->opciones['slotxxxx'] = $this->opciones['permisox'];
        $this->opciones['perfilxx'] = 'sinperfi';
        $this->opciones['rutacarp'] = 'PerfilOcupacionalAdmin.';
        $this->opciones['parametr'] = [];
        $this->opciones['routingx'] = [];
        $this->opciones['carpetax'] = 'PerfilOcupCategoria';
        ...
        $this->opciones['tituloxx'] = "CATEGORÍA DE DESEMPEÑO";
    }
