...
namespace App\Traits\Acciones\Individuales\Educacion\AdmiActiAsd;
...
trait AdmiActiPestaniasTrait
{
     ...
     */
    public $pestania = [
        ['aaasdtiac', '', [], 'TIPOS DE ACTIVIDAD', true, '', 'Tipos de actividad'], // por mínimo debe tener un controllador
        ['aaasdacti', '', [], 'ACTIVIDADES', false, '', 'Actividades'], // por mínimo debe tener un controllador
