...
namespace App\Traits\Acciones\Individuales\Educacion\AdmiActiAsd\AdmiTiac;
...
trait AdmiTiacParametrizarTrait
{
    ...
    public function getOpciones()
    {
        ...
        $this->opciones['tituhead'] = 'Categorias';
        $this->opciones['routxxxx'] = $this->opciones['permisox'];
        $this->opciones['slotxxxx'] = $this->opciones['permisox'];
        $this->opciones['perfilxx'] = 'sinperfi';
        $this->opciones['rutacarp'] = 'Acciones.Individuales.Educacion.AdmiActiAsd.';
        ...
        $this->opciones['tituloxx'] = "Categorias";
    }
