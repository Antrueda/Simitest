...
namespace App\Traits\Indicadores\Administ\Linebase;

/**
 * Este trait permite armar las consultas para ubicacion que arman las datatable
 */
trait LinebaseVistasTrait
{
    public function view()
    {
        ...
        if (!is_null($this->opciones['modeloxx'])) {
            ...
            $this->getRespuesta(['btnxxxxx' => 'a', 'tituloxx' => 'NUEVA','routexxx'=>$this->opciones['permisox'].'.crearxxx']);
        }
        $this->getRespuesta(['btnxxxxx' => 'a', 'tituloxx' => 'VOLVER A LÍNEAS BASE']);
