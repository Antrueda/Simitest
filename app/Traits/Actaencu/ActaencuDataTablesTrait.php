...
trait ActaencuDataTablesTrait
{
    ...
    public function getTablasNnnaj($vercrear)
    {
        $this->opciones['tablasxx'][] = [
            ...
            'columnsx' => [
                ...
                ['data' => 'sexo', 'name' => 'sexo.nombre as sexo'],
                ['data' => 's_localidad', 'name' => 'sis_localidads.s_localidad'],
                ['data' => 's_upz', 'name' => 'sis_upzs.s_upz'],
                ['data' => 's_barrio', 'name' => 'sis_barrios.s_barrio'],
                ['data' => 'direccio', 'name' => 'direccio'],
                ['data' => 's_telefono_uno', 'name' => 'fi_residencias.s_telefono_uno'],
                ['data' => 'tipo_pobla', 'name' => 'tipo_pobla.nombre as tipo_pobla'],
                ['data' => 'perfil', 'name' => 'perfil.nombre as perfil'],
                ['data' => 'lug_foca', 'name' => 'lug_foca.nombre as lug_foca'],
                ['data' => 'autorizo', 'name' => 'autorizo.nombre as autorizo'],
                ['data' => 's_estado', 'name' => 'sis_estas.s_estado'],
            ],
            'tablaxxx' => 'datatable',
            'permisox' => $this->opciones['permisox'],
    ...
    public function getTablasRecursosAdmin($dataxxxx)
    {
        $this->opciones['tablasxx'] = [
            [
                'titunuev' => 'NUEVO RECURSO',
                ...
                'cabecera' => [
                    [
                        ...
                        ['td' => 'UNIDAD MEDIDA', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                        ['td' => 'TIPO RECURSO', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                        ['td' => 'ESTADO', 'widthxxx' => 0, 'rowspanx' => 1, 'colspanx' => 1],
                    ]
                ],
                'columnsx' => [
                    ['data' => 'botonexx', 'name' => 'botonexx'],
                    ['data' => 'id', 'name' => 'ae_recuadmis.id'],
                    ['data' => 's_recurso', 'name' => 'ae_recuadmis.s_recurso'],
                    ['data' => 'umedida', 'name' => 'umedida.nombre as umedida'],
                    ['data' => 'trecurso', 'name' => 'trecurso.nombre as trecurso'],
                    ['data' => 's_estado', 'name' => 'sis_estas.s_estado'],
