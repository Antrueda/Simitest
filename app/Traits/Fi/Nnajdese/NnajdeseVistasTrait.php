 ...
 */
trait NnajdeseVistasTrait
{
    public function getConfigVistas()
    {
        
        $this->opciones['permisox'] = 'nnajdese';

        $this->opciones['vocalesx'] = ['Á', 'É', 'Í', 'Ó', 'Ú'];
        $this->pestania[0][5] = 'active';
        $this->opciones['routxxxx'] = $this->opciones['permisox'];
        $this->opciones['slotxxxx'] = 'fiupinna';
        $this->opciones['infocont'] = 'Nnaj';
        $this->opciones['titucont'] = "SERVICIOS";
        $this->opciones['carpetax'] = 'Nnajdese';
