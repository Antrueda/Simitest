    ...
    function trabajogenera(Request $request)
    {
        if ($request->ajax()) {
            ...
            $respuest = [
                ...
                'combosxx' => [
                    ['comboxxx' => Parametro::find(235)->ComboAjaxUno, 'nombrexx' => '#prm_trabinfo_id', 'selected' => 'selected'],
                    ['comboxxx' => Parametro::find(235)->ComboAjaxUno, 'nombrexx' => '#prm_otractiv_id', 'selected' => 'selected'],
                    ['comboxxx' => Parametro::find(235)->ComboAjaxUno, 'nombrexx' => '#prm_razgeing_id', 'selected' => ''],
                    ['comboxxx' => Parametro::find(235)->ComboAjaxUno, 'nombrexx' => '#prm_tiprelab_id', 'selected' => 'selected'],
                    ['comboxxx' => Tema::combo(123, true, true), 'nombrexx' => '#prm_jorgeing_id', 'selected' => 'selected'],
                    ['comboxxx' => Tema::combo(124, false, true), 'nombrexx' => '#prm_diagener_id', 'selected' => ''],
                    ['comboxxx' => Tema::combo(125, true, true), 'nombrexx' => '#prm_frecingr_id', 'selected' => 'selected'],
