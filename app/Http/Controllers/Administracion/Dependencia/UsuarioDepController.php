...
class UsuarioDepController extends Controller
{
    private $opciones;
    ...
    public function __construct()
    {
        ...
        $this->opciones['rutaxxxx'] = 'usuadepe';
        $this->opciones['routnuev'] = 'usuadepe';
        $this->opciones['routxxxx'] = 'usuadepe';
    ...
    private function view($dataxxxx)
    {
        ...
        $this->opciones['usuariox'] = User::gitDependenciaUser([
    ...
    public function destroy(Request $request)
    {
        if ($request->ajax()) {
            ...
            return response()->json(['messagex' => 'Se ha inactivado el usuario: ' . $flight->id]);
        }
    }
}
