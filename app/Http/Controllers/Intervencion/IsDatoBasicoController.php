  ...
  public function intlista(Request $request, $nnajxxxx) {
    if ($request->ajax()) {
      $actualxx = IsDatosBasico::select([
                  ...
                  'is_datos_basicos.d_fecha_diligencia', 'sis_dependens.nombre', 'users.s_primer_nombre', 'is_datos_basicos.sis_esta_id']
              )
              ->join('sis_dependens', 'is_datos_basicos.sis_dependen_id', '=', 'sis_dependens.id')
