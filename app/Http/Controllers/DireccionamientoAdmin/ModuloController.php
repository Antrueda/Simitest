...
use App\Traits\DireccionamientoAdmin\Modulo\DataTablesModuloTrait;
use App\Traits\DireccionamientoAdmin\Modulo\ParametrizarModuloTrait;
use App\Traits\DireccionamientoAdmin\Modulo\VistasModuloTrait;
...
class ModuloController extends Controller
{
    ...
    {
        $this->opciones['permmidd'] = 'direcadmin';
        $this->opciones['permisox'] = 'direcadmin';
        $this->opciones['routxxxx'] = 'direcadmin';
        $this->getOpciones();
