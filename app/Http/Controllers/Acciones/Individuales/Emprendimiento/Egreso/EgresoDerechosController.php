...
class EgresoDerechosController extends Controller
{
...
*/
    ...
    public function store(EmprenderEgresoCrearRequest $request,SisNnaj $padrexxx)
    {//
    ...
    public function update(VOdontologiaEditarRequest $request,  SEgreso $modeloxx)
    {
