...
use App\Traits\Acciones\Individuales\Educacion\VctOcupacional\FormuVctOcupacional\VctVistasTrait;
...
use App\Traits\Acciones\Individuales\Educacion\VctOcupacional\FormuVctOcupacional\VctParametrizarTrait;
...
class VctOcupacionalController extends Controller
{
    ...
    public function index(SisNnaj $padrexxx)
    {
        ...
        $this->getPestanias([]);
        // $this->getPestaniasWitValidation([]);
