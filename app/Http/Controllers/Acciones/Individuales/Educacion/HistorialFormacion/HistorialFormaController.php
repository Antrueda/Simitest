...
namespace App\Http\Controllers\Acciones\Individuales\Educacion\HistorialFormacion;
use App\Http\Controllers\Controller;
use App\Models\sistema\SisNnaj;
use App\Traits\Acciones\Grupales\Sena\Historial\ParametrizarTrait;
use App\Traits\Acciones\Grupales\Sena\Historial\VistasTrait;
...
class HistorialFormaController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->opciones['permisox'] = 'histocon';
        $this->opciones['routxxxx'] = 'histocon';
        $this->getOpciones();
    ...
    {
        //ddd($padrexxx->FormacionTecnica);
        $this->opciones['tablinde']=true;
        $this->opciones['padrexxx'] = $padrexxx;
        $this->opciones['usuariox'] = $padrexxx->fi_datos_basico;
        $this->pestanix[0]['dataxxxx'] = [false, $padrexxx->id];
        $this->pestanix[1]['dataxxxx'] = [false, $padrexxx->id];
