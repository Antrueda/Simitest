...
class VsiRedsocActualController extends Controller
{
    use VsiTrait;
    private $opciones;
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return $this->getRedesActuales($request);
        }
    }
...
/**
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(VsiRedsocActual $objetoxx)
    {
    ...
    {
        return redirect()
            ->route($this->opciones['routxxxx'] . '.editar', [VsiRedsocActual::transaccion($dataxxxx)->id])
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(VsiRedsocActualEditarRequest $request, VsiRedsocActual $objetoxx)
    {
        return $this->grabar([
            'requestx' => $request,
            'modeloxx' => $objetoxx,
    ...
    public function inactivate(VsiRedsocActual $objetoxx)
    {
    ...
    public function destroy(Request $request, VsiRedsocActual $objetoxx)
    {
