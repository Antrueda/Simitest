...
use App\Traits\MatriculaAdmin\EdaAsignatu\EdaAsignatuCrudTrait;
use App\Traits\MatriculaAdmin\EdaAsignatu\EdaAsignatuDataTablesTrait;
use App\Traits\MatriculaAdmin\EdaAsignatu\EdaAsignatuParametrizarTrait;
use App\Traits\MatriculaAdmin\EdaAsignatu\EdaAsignatuVistasTrait;
...
class EdaAsignatuController extends Controller
{
    ...
    use EdaAsignatuCrudTrait; // trait donde se hace el crud de localidades
    use EdaAsignatuParametrizarTrait; // trait donde se inicializan las opciones de configuracion
    use EdaAsignatuDataTablesTrait; // trait donde se arman las datatables que se van a utilizar
