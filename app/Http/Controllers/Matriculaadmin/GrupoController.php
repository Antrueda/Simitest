...
use App\Traits\Matriculaadmin\Grupo\CrudTrait;
use App\Traits\Matriculaadmin\Grupo\DataTablesTrait;
use App\Traits\Matriculaadmin\Grupo\ParametrizarTrait;
use App\Traits\Matriculaadmin\Grupo\VistasTrait;
...
class GrupoController extends Controller
{
    ...
    public function activar(Request $request, MotivoEgresoSecu $modeloxx)
    {
        ...
        $seguimix=GrupoAsignar::where('motivoese_id',$modeloxx->id);
