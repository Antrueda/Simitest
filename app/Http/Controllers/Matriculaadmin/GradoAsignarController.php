 ...
 */
class GradoAsignarController extends Controller
{
    ...
    {
        $this->opciones['permisox'] = 'gradoasig';
        $this->opciones['routxxxx'] = 'gradoasig';
        $this->getOpciones();
    ...
    public function show(GradoAsignar $modeloxx)
    {
        $this->opciones['pestania'] = $this->getPestanias($this->opciones);
    ...
    public function edit(GradoAsignar $modeloxx)
    {
    ...
    public function inactivate(GradoAsignar $modeloxx)
    {
    ...
    public function destroy(Request $request, GradoAsignar $modeloxx)
    {
    ...
    public function activate(GradoAsignar $modeloxx)
    {
    ...
    public function activar(Request $request, GradoAsignar $modeloxx)
    {
