...
class AIEvasionRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'prm_familiar2_id' => 'nullable|exists:parametros,id',
            'nombre_familiar2' => 'nullable|string|max:120',
            'direccion_familiar2' => 'nullable|string|max:120',
            'tel_familiar2'    => 'nullable|integer',
