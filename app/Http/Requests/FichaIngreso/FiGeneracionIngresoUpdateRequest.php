...
class FiGeneracionIngresoUpdateRequest extends FormRequest
{
    ...
    public function validar()
    {
        ...
        switch($dataxxxx['acgeingr_id']){
            ...
            break;
            // case 853:
            // $this->_mensaje['idibuempl.required'] ='Seleccione mencione días buscando empleo';
            // $this->_reglasx['idibuempl']='required';
            // $this->_mensaje['imebuempl.required'] ='Seleccione mencione meses buscando empleo';
            // $this->_reglasx['imebuempl']='required';
            // $this->_mensaje['ianbuempl.required'] ='Seleccione mencione años buscando empleo';
            // $this->_reglasx['ianbuempl']='required';
            // break;
        }
