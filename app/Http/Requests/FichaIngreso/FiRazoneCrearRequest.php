...
class FiRazoneCrearRequest extends FormRequest {
  ...
  public function __construct() {
    $this->_mensaje = [
        ...
        'sis_depend_id' => 'Seleccione el equipo o área a la que pertenece la persona que diligencia',
        'userr_id' => 'Selecciones la persona responsable',
        'sis_depenr_id' => 'Seleccione el equipo o área a la que pertenece la persona responsable',
        'i_prm_estado_ingreso_id.required' => 'Seleccione el estado del ingreso',
    ];
    $this->_reglasx = [
        's_porque_ingresar' => ['Required'],
        'userd_id' => ['Required'],
        'sis_depend_id' => ['Required'],
        'userr_id' => ['Required'],
        'sis_depenr_id' => ['Required'],
