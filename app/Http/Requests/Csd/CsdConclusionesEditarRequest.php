...
class CsdConclusionesEditarRequest extends FormRequest
{
    private $_mensaje;
    private $_reglasx;
    ...
    public function __construct()
    {
        ...
        $this->_mensaje = [
            ...
            'persona_doc.max'=> 'El numero de documento no puede ser mayor a 14 caracteres',
        ...
        $this->_reglasx = [
            ...
            'persona_doc'       => 'required|string|max:14',
