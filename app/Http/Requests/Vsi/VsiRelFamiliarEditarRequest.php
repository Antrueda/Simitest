...
class VsiRelFamiliarEditarRequest extends FormRequest
{
    private $_mensaje;
    private $_reglasx;
    ...
    public function __construct()
    {
        ...
        $this->_mensaje = [
            ...
            'motivos.required_unless' => 'Seleccione un motivo',
            'prm_gusto_id.required' => 'Seleccione un gusto',
            'porque.required' => 'Indique porque',
            'prm_familia_id.required' => 'Seleccione un familiar',
            'famDificultades.required_if' => 'Seleccione una dificultad',
            'acciones.required_if' => 'Seleccione una acción',
        ...
        $this->_reglasx = [
            ...
            'prm_denunante_id' => 'required_if:prm_denuncia_id,227',
