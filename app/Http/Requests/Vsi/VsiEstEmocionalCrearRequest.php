...
class VsiEstEmocionalCrearRequest extends FormRequest
{
    ...
    public function __construct()
    {
        ...
        $this->_reglasx = [
            ...
            'mes_sueno' => 'nullable:prm_sueno_id,227|min:0|max:99',
            'ano_sueno' => 'nullable:prm_sueno_id,227|min:0|max:99',
            'descripcion_sueno' => 'required_if:prm_sueno_id,227|max:4000',
            'prm_alimenticio_id' => 'required|exists:parametros,id',
            'dia_alimenticio' => 'nullable:prm_alimenticio_id,227|min:0|max:99',
            'mes_alimenticio' => 'nullable:prm_alimenticio_id,227|min:0|max:99',
            'ano_alimenticio' => 'nullable:prm_alimenticio_id,227|min:0|max:99',
