...
class UsuarioIdipronEditarRequest extends FormRequest
{
    ...
    public function rules()
    {
        $this->validar();
        // Reglas para las validaciones de la data de sis_documento_usrs
        $this->_reglasx['s_documento'] = ['required', 'unique:users,s_documento,' . $this->segments()[2]];
        $this->_reglasx['email'] = ['required', 'unique:users,email,' . $this->segments()[2]];
