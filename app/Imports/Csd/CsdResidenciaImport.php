    ...
    */
    public function model(array $row)
    {
        ...
        return new CsdResidencia([
            ...
            'prm_tipo_id'=> $row[1],
            'prm_es_id'=> $row[2],
            'prm_dir_tipo_id'=> $row[3],
            'prm_dir_zona_id'=> $row[4],
            'prm_dir_via_id'=> $row[5],
            'dir_nombre'=> $row[6],
            'prm_tipofuen_id'=>2316,
            'prm_dir_alfavp_id'=> $row[7],
            'prm_dir_bis_id'=> $row[8],
            'prm_dir_alfabis_id'=> $row[9],
            'prm_dir_cuadrantevp_id'=> $row[10],
            'dir_generadora'=> $row[11],
            'prm_dir_alfavg_id'=> $row[12],
            'dir_placa'=> $row[13],
            'prm_dir_cuadrantevg_id'=> $row[14],
            'prm_estrato_id'=> $row[15],
            'dir_complemento'=> $row[16],
            'sis_localidad_id'=> $row[17],
            'sis_upz_id'=> $row[18],
