...
class FiCsdComposicionfamis extends Model
{
    protected $fillable = [
        's_primer_nombre',
        's_segundo_nombre',
      ...
      public static function combo($padrexxx, $cabecera, $ajaxxxxx)
      {
        ...
        foreach (FiCsdComposicionfamis::where('fi_nucleo_familiar_id', $padrexxx->fi_nucleo_familiar_id)->get() as $registro) {
          if ($ajaxxxxx) {
            $comboxxx[] = [
      ...
      public static function getComboResponsable($padrexxx, $cabecera, $ajaxxxxx,$edadxxxx)
      {
        ...
        $compofam=FiCsdComposicionfamis::where(function($consulta) use($padrexxx,$edadxxxx){
