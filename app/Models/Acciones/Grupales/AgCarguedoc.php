...
class AgCarguedoc extends Model
{
    protected $fillable = [
        'ag_actividad_id',
        'i_prm_documento_id',
    ...
    {
        $vestuari = ['docanexa' => AgCarguedoc::where('sis_nnaj_id', $padrexxx)->first(), 'formular' => false];
