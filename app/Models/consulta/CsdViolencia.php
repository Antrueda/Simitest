...
class CsdViolencia extends Model{
    ...
    protected $fillable = ['csd_id', 'prm_condicion_id', 'departamento_cond_id', 'municipio_cond_id', 'prm_certificado_id', 'departamento_cert_id', 'municipio_cert_id', 'user_crea_id', 'user_edita_id', 'activo'];
