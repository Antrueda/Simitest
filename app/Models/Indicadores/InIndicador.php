...
class InIndicador extends Model
{
    ...
    {
        return $this->belongsToMany(InLineaBase::class);
    }
                    ...
                    if (count($documenx->in_doc_preguntas) > 0) {
                        foreach ($documenx->in_doc_preguntas as $pre => $pregunta) {
                            ...
                            $indicado[$contador] = [
                                ...
                                'cantdocu' => 0,
                                'document' => $documenx->sis_docfuen->nombre,
    ...
    public static function getConsulta($dataxxxx)
    {
        return InIndicador::select(
            [
                ...
                'sis_docfuens.id as idocfuen',
                'sis_docfuens.nombre as sdocumen',
            ...
            ->join('in_doc_preguntas', 'in_ligrus.id', '=', 'in_doc_preguntas.in_libagrup_id')
