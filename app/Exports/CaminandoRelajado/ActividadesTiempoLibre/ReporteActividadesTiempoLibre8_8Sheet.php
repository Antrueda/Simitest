...
class ReporteActividadesTiempoLibre8_8Sheet implements FromView, ShouldAutoSize, WithStyles, WithTitle
{
    ...
    {
        return view('administracion.Reportes.Proyectos.export.CaminandoRelajado.ActividadesTiempoLibre.actividadesTiempoLibre8_8View', [
    ...
    {
        return '8.8 Indique sacramentos hechos';
    }
