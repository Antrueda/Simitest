...
class ReporteInformacionBasicaSheet implements FromView, ShouldAutoSize, WithStyles, WithTitle
{
    private $sisNnajs;
    ...
    {
        return view('administracion.Reportes.Proyectos.export.CaminandoRelajado.informacionBasicaView', [
