...
class ReporteConsumoSPA11_1Sheet implements FromView, ShouldAutoSize, WithStyles, WithTitle
{
    ...
    {
        return view('administracion.Reportes.Proyectos.export.CaminandoRelajado.ConsumoSPA.consumoSPA11_1View', [
