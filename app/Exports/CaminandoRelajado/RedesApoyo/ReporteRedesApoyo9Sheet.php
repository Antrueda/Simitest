...
class ReporteRedesApoyo9Sheet implements FromView, ShouldAutoSize, WithStyles, WithTitle
{
    private $sisNnajs;
    ...
    {
        return view('administracion.Reportes.Proyectos.export.CaminandoRelajado.RedesApoyo.redesApoyo9View', [
