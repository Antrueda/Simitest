...
class ReporteTipoPoblacion13_1Sheet implements FromView, ShouldAutoSize, WithStyles, WithTitle
{
    private $sisNnajs;
    ...
    {
        return view('administracion.Reportes.Proyectos.export.CaminandoRelajado.TipoPoblacion.tipoPoblacion13_1View', [
    ...
    {
        return '13.1 Situaciones de vulneraciones.';
    }
