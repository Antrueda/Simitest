<div class="card card-outline card-secondary">
    <div class="card-header">
        ...
        <div class="row">
            <div class="col-md">
                DIRECCIÓN:
                {{ count($dato->FiResidencia)>0 ? $dato->FiResidencia->where('activo', 1)->sortByDesc('id')->first()->direccion : '' }}
            </div>
            <div class="col-md">
                TELÉFONO:
                {{ count($dato->FiResidencia)>0 ? $dato->FiResidencia->where('activo', 1)->sortByDesc('id')->first()->telefonos : '' }}
            </div>
            <div class="col-md">
