<div class="form-group row">
    <div class="form-group col-md-3">
        ...
        {{ Form::select('conve_id', $todoxxxx['convenio'], null, ['class' => $errors->first('nombre') ? 'form-control is-invalid select2' : 'form-control select2']) }}
    ...
    <div class="form-group col-md-3">
        ...
        {{ Form::select('sede_id', $todoxxxx['sedecent'], null, ['class' => $errors->first('nombre') ? 'form-control is-invalid select2' : 'form-control select2']) }}
    ...
    <div class="form-group col-md-3">
        ...
        {{ Form::select('progra_id', $todoxxxx['programa'], null, ['class' => $errors->first('nombre') ? 'form-control is-invalid' : 'form-control','id'=>'progra_id']) }}
    ...
    <div class="form-group col-md-3">
        ...
        {{ Form::select('tipop_id', $todoxxxx['tipoprog'], null, ['class' => $errors->first('nombre') ? 'form-control is-invalid' : 'form-control','id'=>'tipop_id']) }}
    ...
    <div class="form-group col-md-3">
        ...
        {{ Form::select('modal_id', $todoxxxx['modalida'], null, ['class' => $errors->first('nombre') ? 'form-control is-invalid' : 'form-control','id'=>'modal_id']) }}
