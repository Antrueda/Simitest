...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_actividad_id', $actividad, null, ['class' => $errors->first('prm_actividad_id') ? 'form-control form-control-sm is-invalid' : 'form-control float-right form-control-sm', 'onchange' => 'doc(this.value)']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_informal_id', $informal, null, ['class' => $errors->first('prm_informal_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_otra_id', $otros, null, ['class' => $errors->first('prm_otra_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_laboral_id', $laboral, null, ['class' => $errors->first('prm_laboral_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
