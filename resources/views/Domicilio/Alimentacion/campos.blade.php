<div class="row">
  ...
  <div class="col-md-3">
    ...
    {{ Form::select('frecuencia[]', $frecuencia, null, ['class' => $errors->first('frecuencia') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'frecuencia', 'multiple']) }}
  ...
  <div class="col-md-3">
    ...
    {{ Form::select('compra[]', $lugares, null, ['class' => $errors->first('compra') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'compra', 'multiple']) }}
  ...
  <div class="col-md-3">
    ...
    {{ Form::select('ingeridas[]', $alimentacion, null, ['class' => $errors->first('ingeridas') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'ingeridas', 'multiple']) }}
...
<div class="row">
  <div class="col-md-3">
    ...
    {{ Form::select('prm_horario_id', $sino, null, ['class' => $errors->first('prm_horario_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
  ...
  <div class="col-md-3">
    ...
    {{ Form::select('prepara[]', $familiares, null, ['class' => $errors->first('prepara') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'prepara', 'multiple']) }}
  ...
  <div class="col-md-3">
    ...
    {{ Form::select('prm_apoyo_id', $sino, null, ['class' => $errors->first('prm_apoyo_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc(this.value)']) }}
  ...
  <div class="col-md-3">
    ...
    {{ Form::select('prm_entidad_id', $entidad, null, ['class' => $errors->first('prm_entidad_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
