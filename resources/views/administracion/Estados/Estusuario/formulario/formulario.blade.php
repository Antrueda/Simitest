<div class="form-group row">
    ...
    <div class="col-md-3">
        ...
        {{ Form::text('estado', null, ['class' => $errors->first('estado') ? 'form-control  is-invalid' :
            'form-control', 'placeholder' => 'MOTIVO', 'maxlength' => '120', 'autofocus','style'=>'height: 28px','onkeyup' => 'javascript:this.value=this.value.toUpperCase();', 'style' => 'text-transform:uppercase;']) }}
