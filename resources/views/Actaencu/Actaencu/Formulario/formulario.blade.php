...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        {!! Form::select('sis_upz_id', [], null, ['class' => 'form-control form-control-sm select2', 'disabled']) !!}
    ...
    <div class="form-group col-md-4">
        ...
        {!! Form::select('sis_barrio_id', [], null, ['class' => 'form-control form-control-sm select2', 'disabled']) !!}
    ...
    <div class="form-group col-md-6">
        ...
        {!! Form::select('prm_actividad_id', [], null, ['class' => 'form-control form-control-sm select2', 'disabled']) !!}
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_0', 'class' => 'form-control form-control-sm select2']) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_1', 'class' => 'form-control form-control-sm select2']) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_2', 'class' => 'form-control form-control-sm select2']) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_3', 'class' => 'form-control form-control-sm select2']) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_4', 'class' => 'form-control form-control-sm select2']) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_5', 'class' => 'form-control form-control-sm select2']) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_6', 'class' => 'form-control form-control-sm select2']) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_7', 'class' => 'form-control form-control-sm select2']) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_8', 'class' => 'form-control form-control-sm select2']) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::select('', $todoxxxx['entidades'], null, ['id' => 'c_entidad_9', 'class' => 'form-control form-control-sm select2']) !!}</td>
