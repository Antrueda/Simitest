...
<div class="row">
  <div class="col-md">
      ...
      {{ Form::select('prm_vinculado_id',  $todoxxxx["condicio"], null, ['class' => $errors->first('prm_vinculado_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc(this.value)', 'autofocus']) }}
