...
<div class="form-row align-items-end">
  <div class="form-group col-md-4">
    {{ Form::label('amb_amistades', 'Amistades / Colegio', ['class' => 'control-label col-form-label-sm select2']) }}
  </div>
  <div class="form-group col-md-2">
...
<div class="form-row align-items-end">
  <div class="form-group col-md-4">
    {{ Form::label('amb_pareja', 'Pareja', ['class' => 'control-label col-form-label-sm select2']) }}
  </div>
  <div class="form-group col-md-2">
...
<div class="form-row align-items-end">
  <div class="form-group col-md-4">
    {{ Form::label('amb_comunidad', 'Comunitario / Parches', ['class' => 'control-label col-form-label-sm select2']) }}
  </div>
  <div class="form-group col-md-2">
