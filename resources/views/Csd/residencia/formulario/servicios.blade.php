<div class="form-row align-items-end">
    ...
    <div class="form-group col-md-6">
        ...
        {{ Form::select('prm_servicio_id', $todoxxxx["servicio"], null, ['class' => 'form-control form-control-sm select2']) }}
    ...
    <div class="form-group col-md-6">
        ...
        {{ Form::select('prm_legalxxx_id',  $todoxxxx["condicio"], null, ['class' => 'form-control form-control-sm select2']) }}
