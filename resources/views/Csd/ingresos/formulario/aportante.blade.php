<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_aporta_id', $todoxxxx["familiar"], null, ['class' => $errors->first('prm_aporta_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
...
<div class="row">
    ...
    <div class="col-md">
        ...
        {{ Form::select('dias[]', $todoxxxx["diaseman"], null, ['class' => $errors->first('dias') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'dias', 'multiple']) }}
        @if($errors->has('dias'))
            <div class="invalid-feedback d-block">
                {{ $errors->first('dias') }}
            </div>
