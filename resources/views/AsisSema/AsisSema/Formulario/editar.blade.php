...
<div class="form-row">
    ...
    @if ($todoxxxx['modeloxx']->prm_actividad_id == 2710)
    ...
    @endif
    @if ($todoxxxx['modeloxx']->prm_actividad_id == 2707)
    ...
    @endif
    @if ($todoxxxx['modeloxx']->prm_actividad_id == 2708)
    ...
    @endif
    @if ($todoxxxx['modeloxx']->prm_actividad_id == 2709)
