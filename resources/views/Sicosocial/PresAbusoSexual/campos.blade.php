<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_evento_id', $sino, null, ['class' => $errors->first('prm_evento_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc(this.value)', 'autofocus', $vsi->activo == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_momento_id', $evento, null, ['class' => $errors->first('prm_momento_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc1(this.value)', $vsi->activo == 0 ? 'disabled' : '']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_persona_id', $familiares, null, ['class' => $errors->first('prm_persona_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->activo == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_tipo_id', $sexual, null, ['class' => $errors->first('prm_tipo_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc2(this.value)', $vsi->activo == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        <div class="row">
            <div class="col-md-4">
                {{ Form::number('dia_ult', null, ['class' => $errors->first('dia_ult') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Día(s)', 'min' => '0', 'max' => '99', $vsi->activo == 0 ? 'disabled' : '']) }}
            ...
            <div class="col-md-4">
                ...
                {{ Form::number('mes_ult', null, ['class' => $errors->first('mes_ult') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Mes(es)', 'min' => '0', 'max' => '99', $vsi->activo == 0 ? 'disabled' : '']) }}
            ...
            <div class="col-md-4">
                ...
                {{ Form::number('ano_ult', null, ['class' => $errors->first('ano_ult') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Año(s)', 'min' => '0', 'max' => '99', $vsi->activo == 0 ? 'disabled' : '']) }}
                @if($errors->has('anov'))
                    <div class="invalid-feedback d-block">
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_momento_ult_id', $evento, null, ['class' => $errors->first('prm_momento_ult_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->activo == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_persona_ult_id', $familiares, null, ['class' => $errors->first('prm_persona_ult_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->activo == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_tipo_ult_id', $sexual, null, ['class' => $errors->first('prm_tipo_ult_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->activo == 0 ? 'disabled' : '']) }}
...
<div class="row">
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_presencia_id', $sino, null, ['class' => $errors->first('prm_presencia_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->activo == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_reconoce_id', $sino, null, ['class' => $errors->first('prm_reconoce_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->activo == 0 ? 'disabled' : '']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_apoyo_id', $sino, null, ['class' => $errors->first('prm_apoyo_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->activo == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_terapia_id', $sino, null, ['class' => $errors->first('prm_terapia_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc3(this.value)', $vsi->activo == 0 ? 'disabled' : '']) }}
...
<div class="row">
    <div class="col-md-4">
        ...
        {{ Form::select('prm_estado_id', $estado, null, ['class' => $errors->first('prm_estado_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->activo == 0 ? 'disabled' : '']) }}
