<div class="row">
	<div class="col-md-3">
		...
		{{ Form::select('prm_activa_id', $sino, null, ['class' => $errors->first('prm_activa_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc(this.value)', 'autofocus', $vsi->activo == 0 ? 'disabled' : '']) }}
	...
	<div class="col-md-3">
		...
		{{ Form::select('fisiologicas[]', $motivos, null, ['class' => $errors->first('fisiologicas') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'fisiologicas', 'multiple', $vsi->activo == 0 ? 'disabled' : '']) }}
...
<div class="row">
	<div class="col-md-6">
		...
		{{ Form::textarea('conductual', null, ['class' => $errors->first('conductual') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Activación conductual', 'maxlength' => '4000', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase();', 'style' => 'text-transform:uppercase;', $vsi->activo == 0 ? 'disabled' : '']) }}
	...
	<div class="col-md-6">
		...
		{{ Form::textarea('cognitiva', null, ['class' => $errors->first('cognitiva') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Activación cognitiva', 'maxlength' => '4000', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase();', 'style' => 'text-transform:uppercase;', $vsi->activo == 0 ? 'disabled' : '']) }}
