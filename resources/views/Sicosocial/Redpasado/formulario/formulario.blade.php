<div class="row">
    ...
    <div class="col-md">
        ...
        {{ Form::number('ano_prestacion', null, ['class' => $errors->first('ano_prestacion') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'min' => '1980', 'max' => $todoxxxx['hoyxxxxx'], 'placeholder' => 'Año de prestación',"onkeypress" => "return soloNumeros(event);"]) }}
