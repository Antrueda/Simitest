<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_consumo_id', $sino, null, ['class' => $errors->first('prm_consumo_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'autofocus', 'onchange' => 'doc(this.value)', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
        ...
        {{ Form::number('cantidad', null, ['class' => $errors->first('cantidad') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'min' => '0', 'max' => '99', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::number('inicio', null, ['class' => $errors->first('inicio') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Años', 'min' => '0', 'max' => '99', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_contexto_ini_id', $contexto, null, ['class' => $errors->first('prm_contexto_ini_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_consume_id', $sino, null, ['class' => $errors->first('prm_consume_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc2(this.value)', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_contexto_man_id', $contexto, null, ['class' => $errors->first('prm_contexto_man_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_problema_id', $sino, null, ['class' => $errors->first('prm_problema_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
        ...
        {{ Form::text('porque', null, ['class' => $errors->first('porque') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => '¿Por qué?', 'maxlength' => '120', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase();', 'style' => 'text-transform:uppercase;', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_motivo_id', $motivo, null, ['class' => $errors->first('prm_motivo_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md">
        ...
        <div id="expectativas_div">
            {{ Form::select('expectativas[]', $expectativas, null, ['class' => $errors->first('expectativas') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'data-placeholder' => 'Seleccione...', 'multiple', 'id' => 'expectativas', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
        </div>
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_familia_id', $sino, null, ['class' => $errors->first('prm_familia_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc1(this.value)', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
        ...
        <div id="quienes_div">
            {{ Form::select('quienes[]', $familiares, null, ['class' => $errors->first('quienes') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'data-placeholder' => 'Seleccione...', 'multiple', 'id' => 'quienes', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
        </div>
