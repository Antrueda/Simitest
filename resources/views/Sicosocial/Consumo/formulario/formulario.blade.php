<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_consumo_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_consumo_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'autofocus', 'onchange' => 'doc(this.value)']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_consume_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_consume_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc2(this.value)']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_contexto_man_id', $todoxxxx['contexto'], null, ['class' => $errors->first('prm_contexto_man_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_problema_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_problema_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_motivo_id', $todoxxxx['motivosx'], null, ['class' => $errors->first('prm_motivo_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
    ...
    <div class="col-md">
        ...
        <div id="expectativas_div">
            {{ Form::select('expectativas[]', $todoxxxx['expectat'], null, ['class' => $errors->first('expectativas') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'data-placeholder' => 'Seleccione...', 'multiple', 'id' => 'expectativas']) }}
        </div>
    ...
    <div class="col-md">
        ...
        <div id="quienes_div">
            {{ Form::select('quienes[]', $todoxxxx['familiar'], null, ['class' => $errors->first('quienes') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'data-placeholder' => 'Seleccione...', 'multiple', 'id' => 'quienes']) }}
        </div>
