<div class="row">
	<div class="col-md">
		...
		{{ Form::select('motivos[]', $motivos, null, ['class' => $errors->first('motivos') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'motivos', 'multiple', 'autofocus', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
