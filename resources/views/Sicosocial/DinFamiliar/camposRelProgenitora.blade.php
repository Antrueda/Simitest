<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_convive_id', $sino, null, ['class' => $errors->first('prm_convive_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'autofocus', $vsi->activo == 0 ? 'disabled' : '']) }}
