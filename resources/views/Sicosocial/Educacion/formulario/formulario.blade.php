...
<div class="row">
	<div class="col-md-3">
		...
		{{ Form::select('prm_estudia_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_estudia_id') ?
            'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'autofocus']) }}
	...
	<div class="col-md-3">
		...
		{{ Form::select('prm_motivo_id', $todoxxxx['motivosx'], null, ['class' => $errors->first('prm_motivo_id') ? 'form-control form-control-sm is-invalid tiempoxx' : 'form-control form-control-sm tiempoxx', 'onchange' => 'doc2(this.value)']) }}
	...
	<div class="col-md-3">
		...
		<div id="causas_div" >
			{{ Form::select('causas[]', $todoxxxx['causasxx'], null, ['class' => $errors->first('causas') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-s select2', 'data-placeholder' => 'Seleccione...', 'id' => 'causas', 'multiple', $todoxxxx['readonly']]) }}
		</div>
...
<div class="row">
	<div class="col-md-3">
		...
		{{ Form::select('prm_rendimiento_id', $todoxxxx['rendimie'], null, ['class' => $errors->first('prm_rendimiento_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2', 'id' => 'prm_rendimiento_id',]) }}
	...
	<div class="col-md-3">
		...
		{{ Form::select('prm_dificultad_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_dificultad_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','id'=>'prm_dificultad_id']) }}
...
<div class="row">
	<div class="col-md-3">
		...
		<div id="dificultadesa_div" >
			{{ Form::select('dificultadesa[]', $todoxxxx['dificulx'], null, ['class' => $errors->first('dificultadesa') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2', 'data-placeholder' => 'Seleccione...', 'id' => 'dificultadesa', 'multiple']) }}
		</div>
	...
	<div class="col-md-3">
		...
		<div id="dificultadesb_div"> 
			{{ Form::select('dificultadesb[]', $todoxxxx['dificuly'], null, ['class' => $errors->first('dificultadesb') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2', 'data-placeholder' => 'Seleccione...','id' => 'dificultadesb', 'multiple']) }}
		</div>
	...
	<div class="col-md-3">
		...
		{{ Form::select('prm_leer_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_leer_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2']) }}
	...
	<div class="col-md-3">
		...
		{{ Form::select('prm_escribir_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_escribir_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2']) }}
