...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_presenta_id', $todoxxxx['pralreap'], null, ['class' => $errors->first('prm_presenta_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...', 'onchange' => 'doc2(this.value)', 'autofocus']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_protector_id', $todoxxxx['redfacpr'], null, ['class' => $errors->first('prm_protector_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...']) }}
    ...
    <div class="col-md">
        ...
        <div class="row">
            <div class="col-md">
                {{ Form::select('prm_dificultad_id', $todoxxxx['difredap'], null, ['class' => $errors->first('prm_dificultad_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...', 'onchange' => 'doc(this.value)']) }}
...
<div class="row">
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_ruptura_genero_id', $todoxxxx['rupredig'], null, ['class' => $errors->first('prm_ruptura_genero_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_ruptura_sexual_id', $todoxxxx['rupredos'], null, ['class' => $errors->first('prm_ruptura_sexual_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_acceso_id', $todoxxxx['restrede'], null, ['class' => $errors->first('prm_acceso_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2', 'onchange' => 'doc1(this.value)','data-placeholder' => 'Seleccione...']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_servicio_id', $todoxxxx['recsered'], null, ['class' => $errors->first('prm_servicio_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...']) }}
