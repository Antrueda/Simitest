...
<div class="row">
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_protector_id', $todoxxxx['sinoxxxxx'], null, ['class' => $errors->first('prm_protector_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm','data-placeholder' => 'Seleccione...']) }}
    ...
    <div class="col-md">
        ...
        <div class="row">
            <div class="col-md">
                {{ Form::select('prm_dificultad_id', $todoxxxx['sinoxxxxxx'], null, ['class' => $errors->first('prm_dificultad_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm','data-placeholder' => 'Seleccione...', 'onchange' => 'doc(this.value)']) }}
...
<div class="row">
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_ruptura_genero_id', $todoxxxx['sinoxxxxxxx'], null, ['class' => $errors->first('prm_ruptura_genero_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm','data-placeholder' => 'Seleccione...']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_ruptura_sexual_id', $todoxxxx['sinoxxxxxxxx'], null, ['class' => $errors->first('prm_ruptura_sexual_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm','data-placeholder' => 'Seleccione...']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_acceso_id', $todoxxxx['sinoxxxxxxxxx'], null, ['class' => $errors->first('prm_acceso_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc1(this.value)','data-placeholder' => 'Seleccione...']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_servicio_id', $todoxxxx['sinoxxxxxxxxxx'], null, ['class' => $errors->first('prm_servicio_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm','data-placeholder' => 'Seleccione...']) }}
