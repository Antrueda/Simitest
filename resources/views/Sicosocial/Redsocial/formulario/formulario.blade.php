...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_presenta_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_presenta_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...', 'onchange' => 'doc2(this.value)', 'autofocus']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_protector_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_protector_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...']) }}
    ...
    <div class="col-md">
        ...
        <div class="row">
            <div class="col-md">
                {{ Form::select('prm_dificultad_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_dificultad_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...', 'onchange' => 'doc(this.value)']) }}
            ...
            <div class="col-md">
                ...
                {{ Form::select('prm_quien_id', $todoxxxx['personax'], null, ['class' => $errors->first('prm_quien_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...']) }}
...
<div class="row">
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_ruptura_genero_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_ruptura_genero_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...']) }}
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_ruptura_sexual_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_ruptura_sexual_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...']) }}
...
<div class="row">
    <div class="col-md">
        ...
        {{ Form::select('prm_acceso_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_acceso_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2', 'onchange' => 'doc1(this.value)','data-placeholder' => 'Seleccione...']) }}
    ...
    <div class="col-md">
        ...
        <div id="accesos_div">
            {{ Form::select('accesos[]', $todoxxxx['accesoxx'], null, ['class' => $errors->first('accesos') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm select2', 'data-placeholder' => 'Seleccione...', 'id' => 'accesos', 'multiple']) }}
        </div>
    ...
    <div class="col-md">
        ...
        {{ Form::select('prm_servicio_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_servicio_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','data-placeholder' => 'Seleccione...']) }}
