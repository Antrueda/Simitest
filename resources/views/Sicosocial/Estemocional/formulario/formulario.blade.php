...
<div class="row">
	<div class="col-md">
		...
		{{ Form::select('prm_reacciona_id', $todoxxxx['reaccion'], null, ['class' => $errors->first('prm_reacciona_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
...
<div class="row">
	<div class="col-md">
		...
		{{ Form::select('adecuados[]', $todoxxxx['emocione'], null, ['class' => $errors->first('adecuados') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'adecuados', 'multiple']) }}
...
<div class="row">
	<div class="col-md">
		...
		{{ Form::select('prm_estresante_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_estresante_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc(this.value)']) }}
		...
		<div id="estresantes_div">
			{{ Form::select('estresantes[]', $todoxxxx['estresan'], null, ['class' => $errors->first('estresantes') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'estresantes', 'multiple']) }}
		</div>
...
<div class="row">
	<div class="col-md">
		...
		{{ Form::select('prm_morir_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_morir_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc1(this.value)']) }}
	...
	<div class="col-md">
		...
		<div class="row">
			<div class="col-md-4">
				...
				{{ Form::number('dia_morir', null, ['class' => $errors->first('dia_morir') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Día(s)', 'min' => '0', 'max' => '99']) }}
			...
			<div class="col-md-4">
				...
				{{ Form::number('mes_morir', null, ['class' => $errors->first('mes_morir') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Mes(es)', 'min' => '0', 'max' => '99']) }}
			...
			<div class="col-md-4">
				...
				{{ Form::number('ano_morir', null, ['class' => $errors->first('ano_morir') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Año(s)', 'min' => '0', 'max' => '99']) }}
...
<div class="row">
	<div class="col-md">
		...
		{{ Form::select('prm_pensamiento_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_pensamiento_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc3(this.value)']) }}
	...
	<div class="col-md">
		...
		{{ Form::select('prm_amenaza_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_amenaza_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc4(this.value)']) }}
	...
	<div class="col-md">
		...
		{{ Form::select('prm_intento_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_intento_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc5(this.value)']) }}
	...
	<div class="col-md">
		...
		<div class="row">
			<div class="col-md-4">
				...
				{{ Form::number('ideacion', null, ['class' => $errors->first('ideacion') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'min' => '0', 'max' => '99']) }}
			...
			<div class="col-md-4">
				...
				{{ Form::number('amenaza', null, ['class' => $errors->first('amenaza') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'min' => '0', 'max' => '99']) }}
			...
			<div class="col-md-4">
				...
				{{ Form::number('intento', null, ['class' => $errors->first('intento') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'min' => '0', 'max' => '99']) }}
	...
	<div class="col-md">
		...
		<div class="row">
			<div class="col-md-4">
				...
				{{ Form::number('dia_ultimo', null, ['class' => $errors->first('dia_ultimo') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Día(s)', 'min' => '0', 'max' => '99']) }}
			...
			<div class="col-md-4">
				...
				{{ Form::number('mes_ultimo', null, ['class' => $errors->first('mes_ultimo') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Mes(es)', 'min' => '0', 'max' => '99']) }}
			...
			<div class="col-md-4">
				...
				{{ Form::number('ano_ultimo', null, ['class' => $errors->first('ano_ultimo') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Año(s)', 'min' => '0', 'max' => '99']) }}
...
<div class="row">
	<div class="col-md">
		...
		<div id="motivos_div">
			{{ Form::select('motivos[]', $todoxxxx['aconteci'], null, ['class' => $errors->first('motivos') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'motivos', 'multiple']) }}
		</div>
	...
	<div class="col-md">
		<div class="row">
			<div class="col-md">
				...
				{{ Form::select('prm_lesiva_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_lesiva_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc2(this.value)']) }}
			...
			<div class="col-md">
				...
				<div id="lesivas_div">
					{{ Form::select('lesivas[]', $todoxxxx['conducta'], null, ['class' => $errors->first('lesivas') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'data-placeholder' => 'Seleccione...','id' => 'lesivas', 'multiple']) }}
				</div>
	...
	<div class="col-md">
		<div class="row">
			<div class="col-md">
				...
				{{ Form::select('prm_sueno_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_sueno_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc6(this.value)']) }}
			...
			<div class="col-md">
				...
				<div class="row">
					<div class="col-md-4">
						...
						{{ Form::number('dia_sueno', null, ['class' => $errors->first('dia_sueno') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Día(s)', 'min' => '0', 'max' => '99']) }}
					...
					<div class="col-md-4">
						...
						{{ Form::number('mes_sueno', null, ['class' => $errors->first('mes_sueno') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Mes(es)', 'min' => '0', 'max' => '99']) }}
					...
					<div class="col-md-4">
						...
						{{ Form::number('ano_sueno', null, ['class' => $errors->first('ano_sueno') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Año(s)', 'min' => '0', 'max' => '99']) }}
	...
	<div class="col-md">
		<div class="row">
			<div class="col-md">
				...
				{{ Form::select('prm_alimenticio_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_alimenticio_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc7(this.value)']) }}
			...
			<div class="col-md">
				...
				<div class="row">
					<div class="col-md-4">
						...
						{{ Form::number('dia_alimenticio', null, ['class' => $errors->first('dia_alimenticio') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Día(s)', 'min' => '0', 'max' => '99']) }}
					...
					<div class="col-md-4">
						...
						{{ Form::number('mes_alimenticio', null, ['class' => $errors->first('mes_alimenticio') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Mes(es)', 'min' => '0', 'max' => '99']) }}
					...
					<div class="col-md-4">
						...
						{{ Form::number('ano_alimenticio', null, ['class' => $errors->first('ano_alimenticio') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Año(s)', 'min' => '0', 'max' => '99']) }}
