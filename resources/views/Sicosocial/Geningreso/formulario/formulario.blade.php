...
<div class="row">
    ...
    <div class="col-md">
        ...
        {{ Form::number('aporte', null, ['class' => $errors->first('aporte') ? 'form-control col-md-6 form-control-sm is-invalid' : 'form-control form-control-sm', 'min' => '0','id' => 'aporte',"onkeypress" => "return soloNumeros(event);"]) }}
    ...
    <div class="col-md">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                {{ Form::number('cuanto_aporta', null, ['class' => $errors->first('cuanto_aporta') ? 'form-control col-md-6 form-control-sm is-invalid' : 'form-control form-control-sm', 'min' => '0','id' => 'cuanto_aporta',"onkeypress" => "return soloNumeros(event);"]) }}
