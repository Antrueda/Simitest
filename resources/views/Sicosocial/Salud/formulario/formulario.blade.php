...
<div class="row">
	...
	<div class="col-md-3">
		...
		{{ Form::select('prm_medicamento_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_medicamento_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'onchange' => 'doc1(this.value)']) }}
...
<div class="row">
	<div class="col-md-3">
		...
		{{ Form::select('prm_prescripcion_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_prescripcion_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
...
<div class="row">
	...
	<div class="col-md-4">
		...
		{{ Form::select('prm_activa_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_activa_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm']) }}
