...
<div class="row">
	<div class="col-md-3">
        ...
        {{ Form::select('prm_atencion_id', $todoxxxx['sinoxxxx'], null,
            ['class' => $errors->first('prm_atencion_id') ? 'form-control form-control-sm is-invalid' :
                'form-control form-control-sm select2', 'onchange' => 'doc(this.value)', 'autofocus']) }}
	...
	<div class="col-md-3">
		...
		{{ Form::select('prm_condicion_id', $todoxxxx['motivosx'], null, ['class' => $errors->first('prm_condicion_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2']) }}
	...
	<div class="col-md-3">
		...
		{{ Form::select('prm_medicamento_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_medicamento_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2', 'onchange' => 'doc1(this.value)']) }}
...
<div class="row">
	<div class="col-md-3">
		...
		{{ Form::select('prm_prescripcion_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_prescripcion_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2']) }}
...
<div class="row">
	<div class="col-md-4">
		...
		{{ Form::select('prm_sexual_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_sexual_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2', 'onchange' => 'doc3(this.value)']) }}
	...
	<div class="col-md-4">
		...
		{{ Form::select('prm_activa_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_activa_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2']) }}
...
<div class="row">
	<div class="col-md-2">
		...
		{{ Form::select('prm_embarazo_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_embarazo_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2', 'onchange' => 'doc4(this.value)']) }}
	...
	<div class="col-md-2">
		...
		{{ Form::select('prm_hijo_id', $todoxxxx['sinoxxxx'], null, ['class' => $errors->first('prm_hijo_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2', 'onchange' => 'doc5(this.value)']) }}
