<div class="row">
    <div class="col-md-3">
        ...
        {{ Form::select('facilitas[]', $contextos, null, ['class' => $errors->first('facilitas') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'facilitas', 'multiple', 'autofocus', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
...
<div class="row">
    <div class="col-md-3">
        ...
        {{ Form::select('dificultades[]', $contextos1, null, ['class' => $errors->first('dificultades') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'dificultades', 'onchange' => 'doc(this.value)', 'multiple', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md-3">
        ...
        {{ Form::select('prm_dificultad_id', $dificultades, null, ['class' => $errors->first('prm_dificultad_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
    ...
    <div class="col-md-6">
        ...
        {{ Form::textarea('completa', null, ['class' => $errors->first('completa') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Descripción completa', 'maxlength' => '4000', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase();', 'style' => 'text-transform:uppercase;', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
