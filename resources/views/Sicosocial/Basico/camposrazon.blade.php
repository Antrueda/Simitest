<div class="row">
	<div class="col-md-4">
		...
		{{ Form::select('prm_razon_id', $razones, null, ['class' => $errors->first('prm_razon_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
	...
	<div class="col-md-4">
		...
		{{ Form::select('prm_persona_id', $personas, null, ['class' => $errors->first('prm_persona_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
...
<div class="row">
	<div class="col-md-6">
		...
		{{ Form::select('situaciones[]', $situaciones, null, ['class' => $errors->first('situaciones') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'situaciones', 'multiple', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
	...
	<div class="col-md-6">
		...
		{{ Form::select('emociones[]', $emociones, null, ['class' => $errors->first('emociones') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Seleccione...', 'id' => 'emociones', 'multiple', $vsi->sis_esta_id == 0 ? 'disabled' : '']) }}
