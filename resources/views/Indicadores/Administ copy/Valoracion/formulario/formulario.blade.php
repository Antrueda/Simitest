...
<div class="form-group row">
 <div class="form-group col-md-6" style="height: ">
    ...
    {{ Form::select('i_prm_avance_id', $todoxxxx["avancexx"],null, ['class' => 'form-control form-control-sm select2','style'=>'height:38px', $todoxxxx["readonly"]]) }}
  </div>
  <div class="form-group col-md-6">
    {{ Form::label('i_prm_nivel_id', 'Nivel', ['class' => 'control-label col-form-label-sm']) }}
    {{ Form::select('i_prm_nivel_id', $todoxxxx["nivelxxx"], null, ['class' => 'form-control form-control-sm select2','style'=>'height:38px', $todoxxxx["readonly"]]) }}
  </div>
  <div class="form-group col-md-6">
  ...
  <div class="form-group col-md-6">
    ...
    {{ Form::select('i_prm_cactual_id', $todoxxxx["cateactu"], null, ['class' => 'form-control form-control-sm select2s','style'=>'height:38px', $todoxxxx["readonly"]]) }}
  </div>
</div>
<div class="form-group row">
