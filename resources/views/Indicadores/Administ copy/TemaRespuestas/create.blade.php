                            ...
                            <div class="tab-pane active" id="pregunta">
                                <div class="card card-outline card-secondary">
                                    <div class="card text-left">
                                        <div class="card-header">
                                            <h1 style="text-align: center"><strong>ASIGNAR RESPUESTA</strong> </h1>
                                        </div>
                                        <div class="card-body">
                                            <h5 class="card-title"></h5>
                                            <form method="POST" id="formulario"
                                                action="{{ route('temarespuesta.crear') }}"
                                                ...
                                                <div class="form-group row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select class="form-control form-control-sm"
                                                            id="in_ligru_temacombo_id" name="in_ligru_temacombo_id">
                                                            <option value="{{$lineagru->id}}">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select class="form-control form-control-sm" id="parametro_id"
                                                            ...
                                                            <option value="{{$respuestas->parametro->id}}"
                                                                {{ old('parametro_id') == $respuestas->parametro->id ? "selected" :""}}>
                                                                {{$respuestas->parametro->nombre}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group card-footer text-muted text-center">
                                                    <a href="{{ route('temarespuesta', ['padrexxx'=>$respuesta]) }}"
