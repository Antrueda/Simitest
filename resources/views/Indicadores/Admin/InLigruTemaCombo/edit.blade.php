                    ...
                    <div class="card text-left">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" id="formulario"
                                action="{{ route('grupregu.editar', ['objetoxx'=>$lineagru->id]) }}"
                                ...
                                <div class="form-group row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control form-control-sm" id="in_ligru_id"
                                            name="in_ligru_id">
                                            <option value="{{$lineagru->in_ligru_id}}">{{$lineagru->in_ligru_id}}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control form-control-sm" id="temacombo_id"
                                            ...
                                            <option value="{{$temacombo->id}}" @if ($temacombo->id ==
                                                $lineagru->temacombo_id)
                                                selected
                                                @endif
                                                {{ old('temacombo_id') == $temacombo->id ? "selected" : $lineagru->temacombo_id }}>{{$temacombo->nombre}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
