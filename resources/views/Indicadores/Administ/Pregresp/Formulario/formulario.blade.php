...
<div class="form-group row">
    ...
    <div class="form-group col-md-6">
        ...
        {{ Form::select('prm_disparar_id', $todoxxxx['tipopreg']['comboxxx'], null, ['class' => $errors->first('prm_disparar_id') ? 'form-control is-invalid select2' : 'form-control select2','id'=>'prm_disparar_id']) }}
