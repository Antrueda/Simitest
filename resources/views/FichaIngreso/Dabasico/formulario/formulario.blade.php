<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        {{ Form::number('s_documento', null, ['class' => $errors->first('s_documento') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm',"onkeypress" => "return soloNumeros(event);", $todoxxxx['readfisi'],'minlength' => '6', 'maxlength' => '15']) }}
