<div class="form-row">
  ...
  <div class="form-group col-md-4">
    ...
    {{ Form::select('sis_depen_id[]', $todoxxxx['dependen'], null, ['class' => $errors->first('sis_depen_id') ? 'form-control form-control-sm is-invalid select2' : 'form-control form-control-sm select2','id'=>'sis_depen_id','multiple']) }}
  ...
  <div class="form-group col-md-4">
    {{ Form::label('edad', '1.5 Edad (Años)', ['class' => 'control-label']) }}
