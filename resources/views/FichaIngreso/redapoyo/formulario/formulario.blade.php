<div class="form-row align-items-end">
  <div class="form-group col-md-6">
    ...
    {{ Form::select('sis_entidad_id', $todoxxxx["endidadx"], null, ['class' => 'form-control form-control-sm select2']) }}
  </div>
  <div class="form-group col-md-6">
...
<div class="form-row align-items-end">
  <div class="form-group col-md-6">
    ...
    <div class="input-group">
      ...
      {{ Form::select('i_prm_tiempo_id', $todoxxxx["tipotiem"], null, ['class' => 'form-control form-control-sm select2']) }}
    </div>
  </div>
  <div class="form-group col-md-6">
    {{ Form::label('i_prm_anio_prestacion_id', 'Año de prestación del servicio', ['class' => 'control-label']) }}
    {{ Form::select('i_prm_anio_prestacion_id', $todoxxxx["anioserv"], null, ['class' => 'form-control form-control-sm select2']) }}
  </div>
</div>
