@component('bootstrap::modal')
  ...
  <div class="form-row align-items-end">
    ...
    <div class="form-group col-md-3">
      ...
      {{ Form::select('i_prm_tipo_red_id', $todoxxxx["endidadx"], null, ['class' => 'form-control form-control-sm select2', 'required' => 'required']) }}
    </div>
    ...
    <div class="form-group col-md-6">
      ...
      {{ Form::select('sis_entidad_id', $todoxxxx["sexoxxxx"], null, ['class' => 'form-control form-control-sm select2', 'required' => 'required']) }}
    </div>
    <div class="form-group col-md-6">
      ...
      <div class="input-group">
        ...
        {{ Form::select('i_prm_tiempo_id', $todoxxxx["sexoxxxx"], null, ['class' => 'form-control form-control-sm select2', 'required' => 'required']) }}
      </div>
    </div>
    <div class="form-group col-auto">
      {{ Form::label('i_prm_anio_prestacion_id', 'Año de prestación del servicio', ['class' => 'control-label col-form-label-sm']) }}
      {{ Form::select('i_prm_anio_prestacion_id', $todoxxxx["sexoxxxx"], null, ['class' => 'form-control form-control-sm select2', 'required' => 'required']) }}
    </div>

    <div class="form-group col-auto">
      {{ Form::label('sis_servicio_id', 'Servicios o Beneficios Recibidos', ['class' => 'control-label col-form-label-sm']) }}
      {{ Form::select('sis_servicio_id', $todoxxxx["sexoxxxx"], null, ['class' => 'form-control form-control-sm select2', 'required' => 'required']) }}
    </div>
  </div>
  <div class="form-row align-items-end">
