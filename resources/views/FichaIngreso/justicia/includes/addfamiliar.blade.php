...
@endslot
  <div class="form-row align-items-end">
    <div class="form-group col-md-12">
      ...
      {{ Form::select('nombreFamiliar_id', $todoxxxx["sexoxxxx"], null, ['class' => 'form-control form-control-sm select2']) }}
    </div>
  </div>
  <div class="form-row align-items-end">
    <div class="form-group col-md-9">
      {{ Form::label('procesoFamiliar', 'Proceso', ['class' => 'control-label col-form-label-sm']) }}
      {{ Form::select('procesoFamiliar_id', $todoxxxx["sexoxxxx"], null, ['class' => 'form-control form-control-sm select2']) }}
    </div>
    <div class="form-group col-md-3">
      {{ Form::label('vigenteFamiliar', 'Vigente', ['class' => 'control-label col-form-label-sm']) }}
      {{ Form::select('vigenteFamiliar_id', $todoxxxx["sexoxxxx"], null, ['class' => 'form-control form-control-sm select2']) }}
    </div>
  </div>
  <div class="form-row align-items-end">
    ...
    <div class="form-group col-md-6">
      ...
      {{ Form::select('motivoFamiliar_id', $todoxxxx["sexoxxxx"], null, ['class' => 'form-control form-control-sm select2']) }}
    </div>
    <div class="form-group col-md-4">
      ...
      <div class="input-group">
        ...
        {{ Form::select('durProceso_id', $todoxxxx["sexoxxxx"], null, ['class' => 'form-control form-control-sm select2']) }}
      </div>
    </div>
  </div>
