...
<div class="form-row align-items-end">
    ...
    <div class="form-group col-md-6">
        ...
        <div id="prm_situacion_div">
            {{ Form::select('prm_situacion_id[]', $todoxxxx["vincviol"], null, ['class' =>$errors->first('prm_situacion_id') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm select2', 'id'=>'prm_situacion_id','multiple']) }}
        </div>
    </div>
    <div class="form-group col-md-6">
        ...
        {{ Form::select('i_prm_riesgo_participar_id', $todoxxxx["violries"], null, ['class' => 'form-control form-control-sm select2','id'=>'i_prm_riesgo_participar_id']) }}
    </div>
    <div class="form-group col-md-6">
        ...
        <div id="prm_riesgo_div">
            {{ Form::select('prm_riesgo_id[]', $todoxxxx["riesviol"], null, ['class' =>$errors->first('prm_riesgo_id') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm select2','multiple','id'=>'prm_riesgo_id']) }}
        </div>
    </div>
</div>
