...
<div class="row">
  <div class="col-md-3">
    ...
    {{ Form::select('prm_doc2_id', $todoxxxx['document'], null, ['class' => $errors->first('prm_doc2_id') ? 'form-control  col-md-6 form-control-sm is-invalid' : 'form-control float-right form-control-sm']) }}
...
<div class="row">
  <div class="col-md-6">
    @foreach ($todoxxxx['condixxx'] as $condicion)
      <div class="row mt-2">
        <div class="col-md-6">
          <label for="{{ $condicion }}">{{ $condicion }}</label>
        </div>
        <div class="col-md-6">
          {{ Form::select('condiciones[]', $todoxxxx['condicio'], null, ['class' => $errors->first('condiciones') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'id' => 'condiciones']) }}
