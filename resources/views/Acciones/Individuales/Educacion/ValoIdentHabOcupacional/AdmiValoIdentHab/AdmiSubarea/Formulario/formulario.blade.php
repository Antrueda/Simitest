...
<<<<<<< HEAD:resources/views/Acciones/Individuales/Educacion/VctOcupacional/AdmiVctOcupacional/AdmiSubarea/Formulario/formulario.blade.php
    <div class="form-group col-md-6">
        {!! Form::label('vcto_area_id', 'Área:', ['class' => 'control-label']) !!}
        {!! Form::select('vcto_area_id', $todoxxxx['areas'], null, ['name' => 'vcto_area_id', 'class' => 'form-control form-control-sm select2', 'placeholder' => 'Seleccione']) !!}
        @if($errors->has('vcto_area_id'))
        <div class="invalid-feedback d-block">
            {{ $errors->first('vcto_area_id') }}
        </div>
        @endif
    </div>
=======
    ...
    @endisset   
>>>>>>> master:resources/views/Acciones/Individuales/Educacion/ValoIdentHabOcupacional/AdmiValoIdentHab/AdmiSubarea/Formulario/formulario.blade.php
