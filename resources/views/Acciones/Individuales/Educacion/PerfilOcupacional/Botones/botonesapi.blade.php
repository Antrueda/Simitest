...
@endif
@if($requestx->puedinac && $queryxxx->sis_esta_id ==2)
<a class="btn btn-sm btn-success " href="{{ route($requestx->routexxx[0].'.activar', [$requestx->padrexxx,$queryxxx->id]) }}">ACTIVAR</a>
@endif