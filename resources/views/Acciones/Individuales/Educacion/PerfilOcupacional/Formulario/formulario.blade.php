  ...
  <div class="row">
      ...
      <div class="form-group col-md-6">
          ...
          <div class="form-group col-md-6">
              ...
              {{ Form::date('fecha_registro',  null, ['class' => $errors->first('fecha_registro') ? 'form-control form-control is-invalid' : 'form-control form-control-sm','required','max' => $todoxxxx['hoyxxxxx']]) }}
                          ...
                          <div class="tap-perfil-ocupacional tab-pane {{($key==0?'active':'')}}" role="tabpanel" id="step{{$key+1}}">
                              ...
                              @foreach ($item->items as $key2 => $parametro)
                                  ...
                                  <div class="row">
                                      ...
                                      {{-- ANCHO DEL SELECTOR  --}}
                                      <div class="col-md-10"> 
                                          {{ Form::label('step'.($key+1).'_'.($key2+1), strtoupper($parametro->item_nombre), ['class' => 'control-label col-form-label-sm']) }}
                                      </div>
