...
<div class="card p-1">
    <div class="form-group col-md-12">
        ...
        {!! Form::select('prm_remitir',$todoxxxx['si_no'], null, ['name' => 'prm_remitir', 'class' => 'form-control form-control-sm',]) !!}
    ...
    <div class="d-none form-group col-md-12 " id="prm_intrainstitucional_field">
        ...
        {!! Form::select('intrainstitucional',$todoxxxx['areas_for'], null, ['name' => 'intrainstitucional[]', 'class' => 'form-control form-control-sm select2', 'multiple',]) !!}
    ...
    <div class="col-md-12">
        ...
        {!! Form::select('user_res_id', $todoxxxx['funccont'], null, ['class' => 'form-control form-control-sm','required']) !!}
