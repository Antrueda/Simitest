<div class="row">
  ...
  <div class="col-md-3">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        {{ Form::select('prm_hor_sal_id', $ampm, null, ['class' => $errors->first('prm_hor_sal_id') ? 'form-control  col-md-6 form-control-sm is-invalid' : 'form-control float-right form-control-sm select2']) }}
...
<div class="row">
  <div class="col-md-3">
    ...
    {{ Form::select('prm_autorizado_id', $sino, null, ['class' => $errors->first('prm_autorizado_id') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm', 'data-placeholder' => 'Digite el número de documento']) }}
...
<div class="row">
  ...
  <div class="col-md-3">
    {{ Form::label('prm_parentezco2_id', 'Parentezco', ['class' => 'control-label col-form-label-sm']) }}
    {{ Form::select('prm_parentezco2_id', $parentezco, null, ['class' => $errors->first('prm_parentezco2_id') ? 'form-control  col-md-6 form-control-sm is-invalid' : 'form-control float-right form-control-sm select2']) }}
...
<div class="row">
  ...
  <div class="col-md-3">
    ...
    {{ Form::select('prm_copiaDoc_id', $sino, null, ['class' => $errors->first('prm_copiaDoc_id') ? 'form-control select2 form-control-sm is-invalid' : 'form-control select2 form-control-sm select2', 'data-placeholder' => 'Digite el número de documento']) }}
