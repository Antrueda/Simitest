<div class="form-row">
    <div class="form-group col-md-12">
        {!! Form::label('nombre', 'Nombre del Compuesto:', ['class' => 'control-label']) !!}
    ...
    <div class="form-group col-md-12">
        ...
        {!! Form::textarea('descripcion', null, ['class' => 'form-control form-control-sm text-uppercase', 'onkeyup' => "countCharts('descripcion')", 'maxlength' => '4000',]) !!}
