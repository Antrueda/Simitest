...
<div class="row" id="test">
    ...
    <div class="col-sm-3">
      ...
      {{ Form::select('diag_id', $todoxxxx['diagnost'],null, ['class' => $errors->first('diag_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'id' => 'diag_id','required', 'data-placeholder'=>'Seleccione']) }}
