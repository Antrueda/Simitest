...
<div class="card p-1">
    ...
    <div class="form-row mx-1">
        <div class="form-group col-md-12">
            ...
            <div class="input-group">
                {!! Form::select('n_comidas',[0,1,2,3,4,5], null, ['name' => 'n_comidas','required','class' => 'form-control form-control-sm']) !!}
            </div>
                            ...
                            @foreach ($todoxxxx['alimentos'] as $key => $item)
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        ['name' => 'resp_alimentos['.($key).']','required','class' => 'form-control form-control-sm']) !!}
                                    </th>
                                </tr>
                            @endforeach          
                        </tbody>
