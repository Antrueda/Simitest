...
<div class="row">
	<div class="col-md-12">
		...
		{{ Form::select('user_doc1_id', $todoxxxx['usuarioz'], null, ['class' => $errors->first('user_doc1_id') ? 'form-control form-control-sm is-invalid select2' : 'form-control form-control-sm']) }}
...
<div class="row">
	<div class="col-md-12" style="pointer-events:none;">
		...
		{{ Form::select('user_doc2_id', $todoxxxx['usuariox'], null, ['class' => $errors->first('user_doc2_id') ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm select2','id'=>'responsable','placeholder'=>'Seleccione la UPI/Dependencia para cargar el responsable']) }}
