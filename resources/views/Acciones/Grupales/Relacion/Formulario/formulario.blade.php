<div class="form-group row">
    <div class="form-group col-md-6" style="height: ">
        ...
        {{ Form::select('i_prm_trecurso_id', $todoxxxx["tiporecu"], null, ['class' => 'form-control form-control-sm recursos select2','style'=>'height:38px']) }}
    </div>
    <div class="form-group col-md-6" style="height: ">
        {{ Form::label('ag_recurso_id', 'Recurso', ['class' => 'control-label col-form-label-sm']) }}
        {{ Form::select('ag_recurso_id', $todoxxxx["trecurso"], null, ['class' => 'form-control form-control-sm recursos select2','style'=>'height:38px']) }}
    </div>
