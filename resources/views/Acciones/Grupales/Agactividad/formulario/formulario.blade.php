...
<div class="form-group row">
  <div class="form-group col-md-4">
    ...
    {{ Form::date('d_registro', null, ['class' => 'form-control form-control-sm','style'=>'height:38px', $todoxxxx["readonly"]]) }}    
  </div>
  ...
  <div class="form-group col-md-4" style="height: ">
    {{ Form::label('i_prm_lugar_id', 'Lugares/Espacios', ['class' => 'control-label col-form-label-sm']) }}
    {{ Form::select('i_prm_lugar_id', $todoxxxx["lugarxxx"], null, ['class' => 'form-control form-control-sm','style'=>'height:38px', $todoxxxx["readonly"]]) }}
  </div>
  <div class="form-group col-md-4" style="height: ">
    {{ Form::label('sis_depdestino_id', 'UPI/Dependencia', ['class' => 'control-label col-form-label-sm']) }}
