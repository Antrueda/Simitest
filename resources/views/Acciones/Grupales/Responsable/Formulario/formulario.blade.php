<div class="form-group row">
  ...
  <div class="form-group col-md-6">
    ...
    {{ Form::select('i_prm_responsable_id', $todoxxxx['condicio'], null, ['class' => $errors->first('i_prm_responsable_id') ? 'form-control is-invalid select2' : 'form-control ','id'=>'i_prm_responsable_id']) }}
